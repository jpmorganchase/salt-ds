...
tableOfContents:
  ...
  - level: 3
    id: 1-set-up-the-figma-libraries
    text: 1. Set up the Figma libraries
  - level: 3
    id: 2-add-components-to-your-designs
    text: 2. Add components to your designs
  - level: 3
    id: 3-apply-semantic-colors
    text: 3. Apply semantic colors
  - level: 3
    id: 4-select-icons-if-needed
    text: "4. Select icons, if needed"
navigation:
  prev:
