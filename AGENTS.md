...
plan/control and evidence establish no runtime result. The active successor is
[`plans/032-fix-the-real-consumer-entry-path.md`](plans/032-fix-the-real-consumer-entry-path.md).
...
Use `yarn validate:salt-ai:plan-032`,
