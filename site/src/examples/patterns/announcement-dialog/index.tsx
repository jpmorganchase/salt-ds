        ...
        <DialogContent>
          <FlexLayout direction={{ xs: "column", sm: "row" }}>
            <FlexItem grow={1} basis="50%" style={{ minWidth: 0 }}>
              <StackLayout gap={1}>
                <H3 className={styles.announcementHeading}>Builder</H3>
                <Text>
            ...
            <FlexItem
              ...
              style={{ minWidth: 0 }}
            >
              <img alt="" src={exampleImage} className={styles.announcementImage} />
            </FlexItem>
          </FlexLayout>
        </DialogContent>
        <DialogActions>
            ...
            <FlexItem grow={1} basis="50%" style={{ minWidth: 0 }}>
              <StackLayout gap={1}>
                {currentSlide.subheader && (
                  <H3 className={styles.announcementHeading}>
                    {currentSlide.subheader}
                  </H3>
                )}
      ...
      <Dialog open={open} onOpenChange={setOpen} style={{ maxHeight: 420 }}>
        ...
        <DialogContent>
          <FlexLayout direction={{ xs: "column", sm: "row" }}>
            <FlexItem grow={1} basis="50%" style={{ minWidth: 0 }}>
              <StackLayout gap={1}>
                <H3 className={styles.announcementHeading}>Analytics engine</H3>
                <Text>
                ...
                <H3 className={styles.announcementHeading}>Collaboration features</H3>
                <Text>
                ...
                <H3 className={styles.announcementHeading}>Security & compliance</H3>
                <Text>
                ...
                <H3 className={styles.announcementHeading}>Accessibility & theming</H3>
                <Text>
