...
For example, you may choose to create a CTA action that is specific to the primary color in your app. Here the green value `#168757` is the primary value and all state colors are adjusted to ensure 4.5:1 color contrast.

<Image
  src="/img/theming/theming-cta-button-example.png"
  alt="Theming CTA button example"
/>
