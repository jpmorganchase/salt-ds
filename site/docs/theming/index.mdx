...
Theming enables you to modify design variables, such as color or opacity, in a simple and consistent way. 

Salt uses tokens to store design decisions in a single place. Components can reuse tokens, meaning they help to define the design rules and aid the cohesiveness of the overall user interface.
