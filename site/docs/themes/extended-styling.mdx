...
- **Lack of brand alignment**: Custom themes may not reflect JPMorganChase’s brand standards, leading to inconsistent user experiences.
...
For these reasons, Salt’s visual design strategy centers on approved themes (J.P. Morgan, Chase, and JPMorganChase) for long-term use and the Legacy (UITK) theme to support migration from the previous design system. Custom themes are not recommended.
