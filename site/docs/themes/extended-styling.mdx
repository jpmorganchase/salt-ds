...
For these reasons, Salt’s visual design strategy centers on approved themes (JPM Brand, Chase) for long-term use and the Legacy (UITK) theme to support migration from the previous design system. Custom themes are not recommended.
