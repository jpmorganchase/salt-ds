...
For more information, refer to the color usage section in the [data visualization foundation](salt/foundations/data-visualization/color-and-oattern#color-usage). 
