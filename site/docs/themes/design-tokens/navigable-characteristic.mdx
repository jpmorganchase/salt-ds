...
<Diagram
  ...
  alt="Annotated example of navigable items"
...
<Diagram
  ...
  alt="Annotated example of navigable active states"
  background="secondary"
/>
...
<Diagram
  ...
  alt="Annotated example of navigable hover states"
  background="secondary"
/>

<TokenTableWithControls tokens={["--salt-overlayable-background-hover"]} />
...
<Diagram
  ...
  alt="Annotated example of navigation indicators"
  background="secondary"
/>

<TokenTableWithControls tokens={["--salt-navigable-accent-indicator-active"]} />
