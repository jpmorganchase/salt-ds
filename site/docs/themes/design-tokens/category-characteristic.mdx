...
<Diagram
  ...
  alt="Annotated example of category tokens applied to a component"
...
<Diagram
  ...
  alt="Annotated example of bold category tokens"
  background="secondary"
/>
...
<Diagram
  ...
  alt="Annotated example of category tokens applied to data visualization"
  background="secondary"
/>
