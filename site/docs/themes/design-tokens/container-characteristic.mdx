...
<Diagram
  ...
  alt="Annotated example of container backgrounds"
...
<Diagram
  ...
  alt="Annotated example of primary containers"
  background="secondary"
/>
...
<Diagram
  ...
  alt="Annotated example of secondary containers"
  background="primary"
/>
...
<Diagram
  ...
  alt="Annotated example of tertiary containers"
  background="primary"
  border
/>
...
<Diagram
  ...
  alt="Annotated example of ghost containers"
  background="primary"
/>
...
<Diagram
  ...
  alt="Annotated example of drop target containers"
  background="secondary"
/>

<TokenTableWithControls
  tokens={["--salt-target-background-hover", "--salt-target-borderColor-hover"]}
/>
