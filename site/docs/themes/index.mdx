...
- **J.P. Morgan** (default)—_recommended for all new projects._
...
### Setting up the J.P. Morgan theme
...
The J.P. Morgan theme requires the **Amplitude** web font. JPMC employees can download the font files from [Salt internal resources](https://go/salt-ds-internal/resources/index), then add the following `@font-face` declarations to your application CSS:
