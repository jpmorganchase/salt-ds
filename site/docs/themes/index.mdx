...
TODO: We shouldn't entirely remove styling options from the doc, given it's avaialble in code.
Keep in mind that we have a lot more developer audience than designer reading the docs.
...
TODO: Should replace Example 1 & 2 with legacy & brand theme
...
TODO: this is the biggest section needs to be updated
...
// Alongside with existing theme css
