...
The Chase theme enables teams to build and deliver products within the Chase visual identity. Chase is available as a separate library in Figma and as a standalone package in code. J.P. Morgan employees can find [installation instructions and setup guidance](https://go/saltds-chase-theme) internally.
