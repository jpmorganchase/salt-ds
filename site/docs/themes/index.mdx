...
You'll need to install Amplitude font to your application (download from [salt-ds GitHub](https://github.com/jpmorganchase/salt-ds/tree/main/site/public/fonts)) to make sure every user will see the font correctly.
