...
You'll need to install Amplitude font to your application (download from [internal site](https://go/salt-ds-internal/design/fonts) if you're part of JPMC) to make sure every user will see the font correctly.
