...
<Image
  ...
  alt="A side-by-side comparsion of the themes offered by Salt."
/>
...
<Image
  ...
  alt="A screenshot showing Figma devmode usage with Salt's button component."
/>

When referencing a design created using Salt with ‘View only’ Figma access, you’ll be able to see the Figma variables and not the token references. However, the variables match the same structure, so they should be relatively easy to translate.

## What are design tokens?

Design tokens are the building blocks for how Salt styles its components and patterns.

[Learn more about design tokens and their role in Salt.](/salt/themes/design-tokens)
