...
A notification dot badge is a circle dot provides users of changes in state that user needs to be aware of.

Top-right positioning, attached to an element (container and/or text or icon when container not visible)
...
Inline positioning within the container of an element, not directly attached to the element
