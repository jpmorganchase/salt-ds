...
- To organize content within categories, trigger an immediate action, or enable an action that may change depending on context. Instead, use [Pill](/salt/components/pill).
