...
The vertical examples on this page support existing `NavigationItem` implementations. For new vertical navigation, use the [`VerticalNavigation` examples](../vertical-navigation/examples).
...
For an existing vertical `NavigationItem` implementation, nest items to represent a hierarchy of pages. Selecting a parent reveals its nested items.
