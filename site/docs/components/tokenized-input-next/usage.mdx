...
- To generate a list of suggested values that partially match the text entered by the user. Instead, use [`ComboBox`](/salt/components/combo-box/).
- To choose exclusively from options in an existing dataset. Instead, use [`ComboBox`](/salt/components/combo-box/).
