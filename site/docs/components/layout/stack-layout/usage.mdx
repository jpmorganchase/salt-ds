...
- Stack layouts will never wrap. If you want to create a layout in a row that responsively wraps over multiple lines, use [`FlowLayout`](../flow-layout) instead.
- If you want the layout to have more complex customization. In this case, consider [`FlexLayout`](../flex-layout).
