...
To import `Stepper` and related components from the core Salt package, use:

```
import { Stepper, Step, useStepperReducer } from "@salt-ds/core";
```
...
<PropsTable packageName="core" componentName="useStepperReducer" />
