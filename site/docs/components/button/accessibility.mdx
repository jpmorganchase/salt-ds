...
- If the button has focus, Tab moves focus to the next focusable component in the tabbing order.

</KeyboardControl>
<KeyboardControl keyOrCombos="Tab + Shift">

- Tab + Shift moves focus out of the component to the previous component in the tab order.
