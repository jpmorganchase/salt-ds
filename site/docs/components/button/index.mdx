...
title: Button
data:
  description: "`Button` is an interactive component that allows the user to execute an action. There are three appearances and five sentiments. You can display a button with or without a text description or icon, and in various states."
