...
title: Button
data:
  description: Button is an interactive component that allows the user to execute an action. There are three Button variants—call to action (CTA), primary (default) and secondary. You can display Button with or without a text description or icon, and in various states.
