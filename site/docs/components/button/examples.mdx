...
<LivePreview componentName="button" exampleName="Announcement" >

## Announcement

Use the announcement to add additional explanation to screen readers. Ideally used in conjunction with the loading prop.
