...
**Accessibility** - Loading is a visual only state, therefore if you have additional accessibility requirements, please handle it manually.

</LivePreview>

### Examples

<LivePreview componentName="button" exampleName="UpdatePassword" />

## Announcement

<LivePreview componentName="button" exampleName="LoadingAnnouncementProp" >

One way to handle to handle accessibility requirements is to announce a message to screen readers. This can be done by passing the `announcement` prop.

</LivePreview>

<LivePreview componentName="button" exampleName="LoadingAnnouncementChild" >

Another way to achieve the same is to pass a span with role="status" down as a child.
