...
- **Low emphasis**: Reserve it for supporting actions such as dismiss or close. For a primary action against a solid surface, use a more prominent button style.
