...
<LivePreview componentName="button" exampleName="Loading" displayName="Loading - With spinner" >
...
<LivePreview componentName="button" exampleName="LoadingWithLabel" displayName="Loading - Spinner and label" >
...
<LivePreview componentName="button" exampleName="LoadingReplaceIcon" displayName="Loading - Spinner replaces icon" >
