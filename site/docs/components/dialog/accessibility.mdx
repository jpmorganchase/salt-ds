...
Provide an accessible name for dialogs by using a visible header (recommended) or, if design constraints prevent this, apply an `aria-label` attribute directly to the Dialog component to meet WCAG requirements.
