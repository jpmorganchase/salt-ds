...
- Only display a dialog as the result of a user’s action within their workflow, to ensure it remains relevant and is perceived as high priority.

- Use dialog to interrupt user's flow.
