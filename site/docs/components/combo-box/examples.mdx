...
<LivePreview componentName="combo-box" exampleName="WithFormField" displayName="Form Field support" >
...
Combo Box can show validation states (warning, success, error) with the prop `validationStatus`.
