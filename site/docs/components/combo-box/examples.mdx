...
<LivePreview componentName="combo-box" exampleName="Multiselect" displayName="Multi-select" >
...
<LivePreview componentName="combo-box" exampleName="Readonly" displayName="Read-only" >
...
<LivePreview componentName="combo-box" exampleName="WithFormField" displayName="FormField support" >
...
<LivePreview componentName="combo-box" exampleName="ReadonlyMultiselect" >

## Read-only multi-select

When `multiselect={true}` and `readOnly={true}`, users will not be able to interact with the combo box apart from focusing on it.
Use to indicate that the pre-selected values are valid but changes are not permitted.
