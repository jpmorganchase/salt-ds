...
<LivePreview componentName="splitter" exampleName="Overflow">

## Overflow

`SplitPanel` clips it's content by default, to avoid showing scrollbars while resizing. Content can still be configured to overflow within a panel though. This example shows how.
