...
The component comes in two variants: primary and secondary, with default set to primary. To switch to the secondary variant, use `variant="secondary"`. When choosing between the primary and secondary variants, consider the background color on which the component will be placed.
