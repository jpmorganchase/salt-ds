...
Don't rely on color only when using category colors. For more information about making tags accessible, refer to the [accessibility guidelines for tags](https://www.saltdesignsystem.com/salt/components/tag/accessibility).
