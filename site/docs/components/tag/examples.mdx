...
Don't rely on color only when using categorial colors. For more information about making tags accessible, refer to the [accessibility guidelines for tags](/salt/components/tag/accessibility).
