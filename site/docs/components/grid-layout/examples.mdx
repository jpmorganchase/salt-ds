...
Grid Layout defaults to a 12 column grid with one row. The spacing between rows and columns is driven by the prop [gap](/salt/foundations/spacing) and is set to 3.
