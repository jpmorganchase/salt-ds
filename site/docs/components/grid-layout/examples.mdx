...
Grid Layout defaults to a 12 column grid with one row. The spacing between rows and columns is driven by the prop [gap](https://www.saltdesignsystem.com/salt/foundations/spacing) and is set to 3.
...
You can use the default [Salt breakpoints](https://www.saltdesignsystem.com/salt/foundations/responsiveness) or pass in your own using `SaltProvider`.
