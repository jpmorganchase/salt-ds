...
<LivePreview componentName="grid-layout" exampleName="ColumnTemplateAndAutoRows">

## Specifying column template and auto row height

### Column template

Provide an array of [`<length>`s](https://developer.mozilla.org/en-US/docs/Web/CSS/length) to `columns`. Numbers may be used to indicate `fr` units.

### Auto row height

Provide a [`<length>`](https://developer.mozilla.org/en-US/docs/Web/CSS/length) to `rows`.
