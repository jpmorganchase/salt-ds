...
Form fields can wrap any Salt UI control typically found in a form, such as [`Input`](../input), [`Checkbox`](../checkbox) and [`ComboBox`](../combo-box) components. This example shows radio rutton and checkbox controls used within a form field.
