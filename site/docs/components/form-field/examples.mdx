...
Wrap multiple form fields in [`StackLayout`](../layout/stack) to form a group:
...
Use multiple [stack layouts](../layout/stack) inside a group to create a multiple column layout.
...
Use [`GridLayout`](../layout/grid) within a group to create multiple columns where empty slots may be present.
