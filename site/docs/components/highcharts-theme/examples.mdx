...
The `axes-grid-lines` class applied to the container ensures both vertical and horizontal grid lines are displayed.

<Callout title="Note">
  To use the bubble chart, ensure you import the Highcharts `highcharts-more`
