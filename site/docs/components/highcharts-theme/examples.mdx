...
Use a column chart to compare values across categories. Each category is represented by a single vertical bar. To ensure accessible presentation, fill patterns can be applied to the chart (see [Patterns and Fills](./usage#patterns-and-fills) for details).
