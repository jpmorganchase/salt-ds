...
Use a bar chart to compare values across categories. Bars are shown side-by-side for each series. To ensure accessible presentation, fill patterns can be applied to the chart (see [Patterns and Fills](./usage#patterns-and-fills) for details).
...
Use an area chart to show trends over time and the contribution of categories to a total. To ensure accessible presentation, fill patterns can be applied to the chart (see [Patterns and Fills](./usage#patterns-and-fills) for details).
