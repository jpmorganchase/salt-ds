...
Use a scatter chart to show the relationship between two numerical variables. To ensure accessible presentation, fill patterns can be applied to the points (see [Patterns and Fills](./usage#patterns-and-fills) for details).
