...
## Best practices
- 80% `innerSize` provides a good default visual balance.

<LivePreview componentName="highcharts-theme" exampleName="DonutChart" />

## Stacked Bar Chart

Use a stacked bar chart to compare part-to-whole values across categories. To ensure accessible presentation, fill patterns can be applied to the chart (see [Patterns and Fills](./usage#patterns-and-fills) for details).
