...
Interactable cards serve as a Toggle button, Button, Radio button or radio group and Checkbox or checkbox group. They allow the user to embed these elements within for visual affordance.
