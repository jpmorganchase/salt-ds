...
<LivePreviewControls>
    ...
    <LivePreview componentName="card" exampleName="CustomPadding" >
      ...
      - When there is a need to associate a brand or product color to the accent bar, you can override `--saltCard-accentColor` and `--saltCard-accentColor-hover` to achieve your application needs.
    </LivePreview>
