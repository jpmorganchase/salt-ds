...
All card components provide primary, secondary, tertiary and alpha variants, offering flexibility and enabling differentiation based on visual hierarchy within your UI.
