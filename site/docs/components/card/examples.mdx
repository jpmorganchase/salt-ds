...
- Customize the spacing using the `--saltCard-padding`, `--saltLinkCard-padding` or `--saltInteractableCard-padding` CSS properties. When `CardContent` is used, customize the inner spacing using `--saltCardContent-padding`.
