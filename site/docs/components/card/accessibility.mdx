...
To meet accessibility standards, the boundaries of a user interface component are only subjective to the 3:1 contrast minimum if they serve to identify the components purpose.
