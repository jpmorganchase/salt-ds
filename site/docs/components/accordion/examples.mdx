...
<LivePreview componentName="accordion" exampleName="ArrowAlignment" >

## Arrow Alignment

Use the `arrowAlignment` prop to customise which side the arrow is displayed in accordion header.
