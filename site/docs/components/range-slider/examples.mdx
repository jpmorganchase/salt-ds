...
You can display marks under the slider track between the minimum and maximum labels to highlight certain values.

Please note that minimum and maximum labels will always be visible and you can not control them through `marks`. Refer to the [Custom Min/Max labels](#with-custom-minmax-labels) example for more details.

</LivePreview>

<LivePreview componentName="range-slider" exampleName="WithCustomLabels">

## With Custom Minimum and Maximum labels

You can customize the minimum and maximum labels.
