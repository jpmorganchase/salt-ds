...
<Callout title="Note">
  <ul>
    <li>
      ...
      applied to the chart (see [Patterns and Fills](./usage#patterns-and-fills)
      for details). Use the "Show patterns" switch to toggle patterns.
    </li>
    <li>
      This package is a WIP. Current issues are [tracked
      here](https://github.com/jpmorganchase/salt-ds/issues/5878).
    </li>
  </ul>
</Callout>
