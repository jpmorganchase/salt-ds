...
<Callout title="Note">
  <ul>
    <li>
      To ensure the presentation is accessible, line or fill patterns can be
      applied to the chart. See [Module loading](./usage#module-loading) for
      version-specific Highcharts module setup and [Patterns and
...
<Callout title="Note">
  To use the heatmap chart, import the Highcharts `heatmap` module and use it to
  wrap the `Highcharts` object as shown in the example.
</Callout>

<LivePreview componentName="chart" exampleName="HeatmapChart" />
