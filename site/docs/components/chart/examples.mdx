...
Use a bubble chart to show the relationship between two variables, with a third variable represented by the size of each bubble. This is helpful for visualizing clusters and outliers across categories.
