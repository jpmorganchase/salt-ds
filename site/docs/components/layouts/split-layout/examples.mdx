...
The split layout component supports responsive props, so you can define different behaviors based on viewport size. You can use the default [Salt breakpoints](/salt/foundations/responsiveness/breakpoints) or pass in your own using `SaltProvider`.
