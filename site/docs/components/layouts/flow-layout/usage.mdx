...
- A flow layout will always wrap. If you want to create a layout in a row that doesn’t wrap, use [`StackLayout`](../stack-layout).
- If you want the layout to have more complex customization. In this case, we recommend [`FlexLayout`](../flex-layout).
