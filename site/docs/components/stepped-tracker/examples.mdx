...
Use a vertical stepped tracker when horizontal space is limited in the context of the application or when there are a large number of steps in the process – for example, more than 8.
  ...
  <LivePreview componentName="stepped-tracker" exampleName="SingleLabel" >

## Single Label

You can change the alignment of labels to either `left` or `center`.

### Best practices

Use `left` alignment when using a single label and you don't want any additional padding created by centered labels.
