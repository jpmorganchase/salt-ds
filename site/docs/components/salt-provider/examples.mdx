...
It is recommended to use `"touch"` density on touchscreen/mobile devices. There are a few ways to achieve this:

1. Passing a responsive value to the `density` prop.
2. Using media queries or other methods to detect devices.
