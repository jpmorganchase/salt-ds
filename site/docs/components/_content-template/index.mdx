...
<!--
  ...
  Describe how the component behaves in responsive layout situations, and any
...
<!--
  ...
  ![Text alternative for the visual anatomy](./path/to/anatomy.jpg)

  If the diagram features numbered callouts, add a numbered markdown list with
...
<!--
  Provide a diagram of the component spec'd out in all densities (or medium
  only?) showing spacing and padding:

  ![Text alternative for the spacing spec](./path/to/spacing.jpg)
-->
...
<!--
  ...
  * [Full component specification (in Figma)](https://figma.com/path/to/spec)
...
<!--
  A table of the props for this component in the following format:
...
|       |             |                     |          |                |
  ...
  Typically, this should be auto-generated from the source code. In Storybook
  use:
