...
<!--
  Add a bulleted list of best practices and princples that are relevant to this
  component. Where other pages on the site explain those principles in more
  detail, consider linking to them rather than repeating the explanation here.
-->
