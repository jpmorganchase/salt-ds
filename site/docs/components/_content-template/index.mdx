...
component:
  ...
  # [REQUIRED] The version of the NPM package that this component first appeared
  # in
  ...
  # [OPTIONAL] A list of other components that are related to this component and
...
<!--
  Add a code sample of the API call required to import this component into your
  application.
-->
