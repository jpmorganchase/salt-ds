...
To import `SidePanel` and related components from the core Salt package, use:
...
<PropsTable packageName="core" componentName="SidePanel" />

### SidePanelProvider

<PropsTable packageName="core" componentName="SidePanelProvider" />

### SidePanelTrigger

<PropsTable packageName="core" componentName="SidePanelTrigger" />

### SidePanelCloseButton

<PropsTable packageName="core" componentName="SidePanelCloseButton" />

### SidePanelHeader

<PropsTable packageName="core" componentName="SidePanelHeader" />

### SidePanelTitle

<PropsTable packageName="core" componentName="SidePanelTitle" />

### SidePanelContent

<PropsTable packageName="core" componentName="SidePanelContent" />
