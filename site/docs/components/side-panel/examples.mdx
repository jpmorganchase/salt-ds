...
Use `variant="none"` when the side panel needs a custom visual treatment. This removes the default panel background and divider so the surrounding background can show through, or so you can compose your own container inside the panel.

<LivePreview componentName="side-panel" exampleName="CustomContainer" />
