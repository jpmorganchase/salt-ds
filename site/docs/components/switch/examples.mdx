...
Use a disabled state for switches that have permissions, dependencies or pre-requisites. For example, a switch in a Form may be disabled because the user has not yet completed an earlier section of the form.
...
Use a disabled checked state for switches that have permissions, dependencies or pre-requisites. For example, a switch in a Form may be checked but disabled as the user does not have permissions to edit their selection during a later stage in a form.
