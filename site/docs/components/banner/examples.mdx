...
Use `variant="secondary"` to provide additional emphasis to the banner.
  ...
  <LivePreview componentName="banner" exampleName="MultipleActionButtons" >

## Multiple Action Buttons

Use the Multiple Action Buttons banner to have multiple action buttons for beneath the banner content.
