...
<br />A status icon displays alongside a supporting message.
...
<br />A warning icon displays alongside a supporting message.
...
<br />A success icon displays alongside a supporting message.
...
<LivePreview componentName="banner" exampleName="MultilineBanners" />
