...
data:
  description: |
    Banner 
    is a type of notification that displays a message or provides feedback related to the user’s current workflow and spans the page or container horizontally. It can represent new information, errors, warnings or successful completion of a process or task.
