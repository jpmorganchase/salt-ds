...
`TabNextAction`s can be used to add actions to tabs e.g. dismissing a tab. When dismissing a tab, a warning dialog may be used when dismissing a tab will result in data loss.
