...
When focus is within the list, this action moves focus to the item before the first visible option.

</KeyboardControl>
<KeyboardControl keyOrCombos="Page down">

When focus is within the list, this action moves focus to the item after the last visible option.
