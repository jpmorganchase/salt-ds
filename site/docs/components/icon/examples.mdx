...
You can also use icon as background image in CSS from `"@salt-ds/icon/css/salt-icons.css"`, then specify icon name prefixed with `saltIcon-`, e.g., `saltIcon-AddDocument`.
