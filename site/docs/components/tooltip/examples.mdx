...
<LivePreviewControls>
  ...
  <LivePreview componentName="tooltip" exampleName="Status" displayName="Status">
    ...
    - Info: Use when you need to display general information.
    - Error: Use to communicate a critical issue that prevents the user from continuing or completing it.
    - Warning: Use to inform users of an issue or potential issue related to their current task. Use this for issues that do not prevent the user from continuing or completing their task.
    - Success: Use to confirm that a user's action has been completed successfully.
