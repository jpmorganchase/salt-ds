...
<LivePreview componentName="tooltip" exampleName="FlipAndShift" displayName="Flip and shift">

### Flip and shift

The component moves automatically when there's limited screen space, so it remains visible.
