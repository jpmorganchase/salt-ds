...
- Use an existing Salt component which integrates Status Indicator such as [Banner](/salt/components/banner), [Toast](/salt/components/toast) or [Tooltip](/salt/components/tooltip) where appropriate.
