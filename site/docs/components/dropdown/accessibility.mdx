...
- If the list is closed, opens the list and moves visual focus to the first option.

</KeyboardControl>
<KeyboardControl keyOrCombos="End">

- If the list is open, moves visual focus to the last option.
- If the list is closed, opens the list and moves visual focus to the last option.
