...
<LivePreview componentName="dropdown" exampleName="WithFormField" displayName="FormField support" >
...
In order to achieve select all functionality, you can pass the first Option as Select All and pass in the logic to handleSelectionChange prop.
