...
- When you have large number (>100) of list items, to prevent performance issues without virtualisation, we strongly recommend adding a filter e.g. use a [Combo Box](../combo-box) instead of Dropdown
