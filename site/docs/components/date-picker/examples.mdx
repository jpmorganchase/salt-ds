...
<LivePreview componentName="date-picker" exampleName="CompactRange">
## Compact Date range

The Compact Date Range Picker enables selection of start and end dates, using the input fields or one calendars displayed in case of mobile viewport.
