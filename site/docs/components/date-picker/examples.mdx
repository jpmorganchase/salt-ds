...
<LivePreview componentName="date-picker" exampleName="SingleWithLocaleUS">
## Single select with locale US

</LivePreview>
<LivePreview componentName="date-picker" exampleName="RangeWithLocaleES">
## Date range with locale ES
