...
<LivePreview componentName="date-picker" displayName="Composed DatePicker for Single Date Selection" exampleName="Single">
...
<LivePreview componentName="date-picker" displayName="Composed DatePicker for Date Range Selection" exampleName="Range">
