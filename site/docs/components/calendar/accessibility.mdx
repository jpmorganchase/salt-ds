...
<KeyboardControls>
  <KeyboardControl keyOrCombos="Tab">
    ...
    - If focus is on a day, Tab moves focus to the next focusable component.
  </KeyboardControl>
  <KeyboardControl keyOrCombos="Shift + Tab">
    - This action moves focus to the previous focusable component within the calendar.
    - If focus is on the previous month arrow button, Shift + Tab moves focus to the previous focusable component.
  </KeyboardControl>
  ...
  <KeyboardControl keyOrCombos="Enter / Space">
    - If the left or right arrow button has focus, this action navigates the calendar to the previous or next month respectively. Focus remains on the button.
