...
Disabled dates are not selectable. To implement this, use the `isDayDisabled` prop to pass a function that determines whether a day is disabled and provides the tooltip description.
