...
<LivePreview componentName="calendar" displayName="Multiselect" exampleName="Multiselect">
## Multi-select
...
<LivePreview componentName="calendar" displayName="Custom Day Render" exampleName="CustomDayRender">
## Custom date rendering
To customize the rendering of a date element, use the `renderDayContents` prop with the `Calendar` component. This prop accepts a function that is passed a `DateValue` and returns the custom element for that date. This can be useful for scenarios where you need to display additional information or apply custom styling to specific dates.
</LivePreview>

<LivePreview componentName="calendar" displayName="Hide out-of-range dates" exampleName="HideOutOfRangeDates">
...
<LivePreview componentName="calendar" displayName="Constrained date selection" exampleName="MinMaxDate">
...
<LivePreview componentName="calendar" displayName="Bordered" exampleName="Bordered">
## Bordered calendar
...
<LivePreview componentName="calendar" displayName="Twin Calendars" exampleName="TwinCalendars">
## Twin calendars
...
<LivePreview componentName="calendar" displayName="With locale" exampleName="WithLocale">
## Locale
...
<LivePreview componentName="calendar" displayName="Custom header" exampleName="CustomHeader">
## Custom header
