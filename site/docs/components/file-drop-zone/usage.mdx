...
- We recommend passing a title paragraph to the component to indicate the expected action.
...
- To inform users of the criteria, you can display custom validation text on the file drop zone. If uploaded files fail to meet the validation criteria, the file drop zone will display an error state.
