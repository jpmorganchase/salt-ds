...
- To inform users of the criteria, you can display custom validation text on the file drop zone. If uploaded files fail to meet the validation criteria, change `state` prop to `error` so the file drop zone will display the error state.
