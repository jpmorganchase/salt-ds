...
title: Checkbox
data:
  description: Checkbox and Checkbox Group allow the user to turn a specific option on or off. It can stand alone to toggle a single option, or form part of a checkbox group to toggle multiple options.
