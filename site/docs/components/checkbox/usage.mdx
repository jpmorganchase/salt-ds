...
- The checkbox displays a mutually exclusive choice between two or more values, in that case a Radio Button is more appropriate.
- If you want to display a single option but trigger a state change directly and immediately, consider using a Switch instead.
