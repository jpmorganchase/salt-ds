...
Use a disabled state for checkboxes that have permissions, dependencies or pre-requisites. For example, a checkbox in a [Form](../patterns/forms) may be disabled because the user has not yet completed an earlier section of the form.
...
For more information, refer to the [Form Field](../patterns/forms) guidance.
