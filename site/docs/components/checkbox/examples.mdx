...
<LivePreview componentName="checkbox" exampleName="WithSecondaryLabel" >

## WithSecondaryLabel

You can use checkbox with secondary label by passing the `label` prop with StackLayout as a wrapper and having primary and secondary text inside that.
