...
<GuidanceCallout type="positive" customPillText="Best practices">
  - Continue cycling through the frames with 5–7s delays - Add a progress
  indicator - Pause the animation upon hover - Stop the slideshow upon any user
  interaction with content and do not resume, unless the user restarts it with
  the play button
</GuidanceCallout>
