...
The carousel can display slides with a fixed width that remains constant regardless of viewport size by overriding the `--carousel-slide-size` CSS custom property with a fixed value (e.g. `550px`).
