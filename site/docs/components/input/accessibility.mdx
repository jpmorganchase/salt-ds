...
- To be considered accessible within a form, the Input must be wrapped in a [Form Field](/salt/components/form-field). This will provide the field with a visible label, help text and a status message for validation feedback.
