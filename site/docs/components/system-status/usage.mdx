...
<PropsTable packageName="core" componentName="SystemStatus" />

### `SystemStatusContent`

<PropsTable packageName="core" componentName="SystemStatusContent" />

### `SystemStatusActions`

<PropsTable packageName="core" componentName="SystemStatusActions" />
