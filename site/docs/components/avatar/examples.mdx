...
The `category` prop can be used to change Avatar's background to one of the 20 [categorical colors](/salt/foundations/color#categorical). If an invalid category is passed Avatar will use the accent color.
