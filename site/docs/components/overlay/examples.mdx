...
<LivePreviewControls>
  <LivePreview componentName="overlay" exampleName="Default" displayName="Default Overlay">
    ...
    - Add the props `aria-labelledby="overlay_label"` and `aria-describedby="overlay_description"` to `Overlay` component.
    - Add the corresponding prop `id="overlay_label"` to your content label, and prop `id="overlay_description"` to your content description.
