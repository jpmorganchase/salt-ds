...
`OverlayPanelCloseButton` can be rendered as a child of the `OverlayPanel` component to render a close button in the top right corner of the OverlayPanel. You can pass the `onClick` prop like with any `Button` component to handle the close button click.
