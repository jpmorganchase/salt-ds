...
<LivePreviewControls>
  <LivePreview componentName="overlay" exampleName="Default" displayName="Default Overlay">
    ...
    - Define an `id` and pass the prop `id="YOUR-OVERLAY-ID"` to `Overlay` component.
    - Add the corresponding prop `id="YOUR-OVERLAY-ID-header"` to your content header or title, and prop `id="YOUR-OVERLAY-ID-content"` to your content description.
