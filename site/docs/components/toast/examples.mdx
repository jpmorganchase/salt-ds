...
An error toast can notify users of a failure when essential error details and recovery actions remain available in the owning view. For a failure that users need to resolve within a form, follow the [Forms feedback guidance](/salt/patterns/forms#choosing-feedback). An error icon displays alongside a title and supporting message.
