...
- If the user hasn't checked a radio button, focus moves to the first radio button in the group.

</KeyboardControl>
<KeyboardControl keyOrCombos="Space">

- If the user hasn't checked the radio button with focus, changes the state to checked.
