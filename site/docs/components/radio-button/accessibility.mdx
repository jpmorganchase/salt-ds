...
- Screen reader behavior: Selection follows focus. On focus, the screen reader should announce the following:
  - identify itself as a radio button,
  - read out the text,
  - express the state and state the position of the radio button within the list of options available.
