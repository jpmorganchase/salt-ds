...
- When you have a Boolean selection (on/off). Instead, use [Switch](../components/switch).
- When you have fewer than five options and multiple selection is required. Instead, use [Checkbox Group](../components/checkbox).
- When you have more than five and fewer than 10 options. Instead, use [Dropdown](../components/dropdown).
