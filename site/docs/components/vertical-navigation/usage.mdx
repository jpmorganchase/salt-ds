...
To import `VerticalNavigation` and related components from the lab Salt package, use:
...
<PropsTable packageName="lab" componentName="VerticalNavigation" />

### VerticalNavigationItem

<PropsTable packageName="lab" componentName="VerticalNavigationItem" />

### VerticalNavigationItemContent

<PropsTable packageName="lab" componentName="VerticalNavigationItemContent" />

### VerticalNavigationItemTrigger

<PropsTable packageName="lab" componentName="VerticalNavigationItemTrigger" />

### VerticalNavigationItemLabel

<PropsTable packageName="lab" componentName="VerticalNavigationItemLabel" />
...
<PropsTable packageName="lab" componentName="VerticalNavigationSubMenu" />
