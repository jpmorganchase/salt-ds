...
```js
import { DateInputRange } from "@salt-ds/date-components";
```
...
<PropsTable packageName="date-components" componentName="DateInputSingle" />

### DateInputRange

<PropsTable packageName="date-components" componentName="DateInputRange" />
