...
<KeyboardControls>
  <KeyboardControl keyOrCombos="Tab">
    ...
    - If the input has focus, Tab moves focus out of the input, to next focusable component in the tab order and formats the date.
