...
Never apply RAG (status) colors to pills to differentiate between categories. Use [icons](/salt/components/icon) or text instead.

#### When to use `PillNext`
