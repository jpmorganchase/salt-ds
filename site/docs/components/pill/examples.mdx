...
<LivePreviewControls>
  ...
  <LivePreview componentName="pill" exampleName="Closable">
    ...
    The Closable Pill represents a value that was selected via another mechanism, and which can be removed within the Pill. It can appear on its own, for example, alongside a complex filter panel—or within an input control such as Combo Box.
