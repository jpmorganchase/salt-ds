...
Use `useAriaAnnouncer` to announce character count updates to screen reader users without moving focus. When the user first exceeds the limit, make the announcement assertive so they receive immediate feedback.
