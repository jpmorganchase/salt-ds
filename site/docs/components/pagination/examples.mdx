...
You can use a combination of `CompactPaginator` and `GoToInput` if you want a compressed version of Pagination, but you also want a pagination imput with a label.
