...
- To present a set of static list items. It can be used with a File drop zone to show the list of files added. It can also be used to create a shopping cart list.
