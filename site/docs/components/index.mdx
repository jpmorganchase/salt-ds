...
Our [accessibility evidence model](/salt/about/accessibility-evidence) distinguishes
the standard we target from behavior that has been tested, supported combinations,
known exceptions and formal conformance. The pilot evidence is intentionally
component-specific and does not establish conformance for the full library.
