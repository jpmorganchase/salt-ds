...
The {meta.labsIcon} symbol denotes components that are under active development. These may not function as expected and may change due to feedback. You should exercise caution. You can find them in the `@salt-ds/lab` package. The use of lab components not listed on the website is not encouraged since they aren't receiving active development.
