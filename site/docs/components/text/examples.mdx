...
Nest `<strong>` or `<small>` elements inside `Text` to adjust font weight.

Read our [guidance on how to use font weight](/salt/foundations/typography#font-weight).

<LivePreview componentName="text" exampleName="Weight" />
