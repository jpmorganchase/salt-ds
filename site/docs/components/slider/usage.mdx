...
Display labels as numbers so they remain as short as possible and don't overlap with each other or with the Slider. If labels are overlapping, adjust the Slider width and/or number of visible increments.
