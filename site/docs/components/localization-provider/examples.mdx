...
The `LocalizationProvider` defines the locale used by Salt's date based controls such as [Calendar](../Calendar), [DateInput](../date-input) and [DatePicker](../date-picker).
