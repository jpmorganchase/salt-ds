...
Cells can show validation states (warning, success and error) using the classnames `.salt-grid-cell-warning`, `.salt-grid-cell-success` and `.salt-grid-cell-error`.

<LivePreview componentName="ag-grid-theme" exampleName="CellValidation" />

## Row validation

Rows can show validation states (warning, success and error) using the classnames `.salt-grid-row-warning`, `.salt-grid-row-success` and `.salt-grid-row-error`.
