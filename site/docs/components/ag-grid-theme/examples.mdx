...
Cells can show validation states (warning, success and error) using the classnames `.warning-cell`, `.success-cell` and `.error-cell`.

<LivePreview componentName="ag-grid-theme" exampleName="CellValidation" />

## Row validation

Rows can show validation states (warning, success and error) using the classnames `.warning-row`, `.success-row` and `.error-row`.
