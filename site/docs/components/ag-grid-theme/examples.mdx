...
To increase the visual contrast between the header add the header modifier classes alongside the mode class on the grid wrapper.

Header background variants:

- `ag-theme-salt-header-primary` (default)
- `ag-theme-salt-header-secondary`
- `ag-theme-salt-header-tertiary`

Header divider variants:

- `ag-theme-salt-header-divider-primary` (default — strong divider)
- `ag-theme-salt-header-divider-secondary`
- `ag-theme-salt-header-divider-tertiary`
- `ag-theme-salt-header-divider-none`
