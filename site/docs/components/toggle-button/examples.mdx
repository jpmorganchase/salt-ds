...
Standalone toggle buttons should be used sparingly, with the usage of other selection controls being preferred. They are best suited for situations where a single button is needed to switch between two distinct states.
