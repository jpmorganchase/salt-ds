...
<LivePreview componentName="toggle-button" exampleName="ToggleButtonGroupDefault" >
...
<LivePreview componentName="toggle-button" exampleName="ToggleButtonGroupVertical" >
