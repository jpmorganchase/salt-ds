...
- To visually prioritize options higher than a [radio button](../radio-button) or a [switch](../switch).
...
- To present options in a toggle button group within a compact UI, or if they’re subject to change depending on context. Instead, use [`SelectablePill`](../pill).
