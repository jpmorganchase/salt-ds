...
- If the active button is disabled, or no button is active, focus is set to the first enabled button.
...
- This action moves focus to the next enabled toggle button in the toggle button group.
- If focus is on the last enabled toggle button, this action wraps focus to the first enabled toggle button.

</KeyboardControl>
<KeyboardControl keyOrCombos="Left arrow / Up arrow">

- This action moves focus to the previous enabled toggle button in the toggle button group.
- If focus is on the first enabled toggle button, this action wraps focus to the last enabled toggle button.
