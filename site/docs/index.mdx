...
frameOverrides:
  header:
    ...
    menu: []
data:
  summary: "Use Salt foundations, components, patterns, tokens and themes to create accessible product experiences."
  applicability: "Designers and developers evaluating or using the public Salt Design System."
  stability: "stable"
