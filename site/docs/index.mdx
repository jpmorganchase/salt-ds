...
<Impact
  impacts={[
    ...
    {
      title: "WCAG 2.2 accessibility target",
      description:
        "We target WCAG 2.2 Level AA and publish component-level evidence for tested behavior, limitations and manual testing status.",
    },
    {
