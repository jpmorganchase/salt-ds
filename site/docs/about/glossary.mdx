...
Below are definitions of terms commonly used in Salt design system content, communications and documentation. The terms are listed in alphabetical order.
...
A guide to fundamental principles that help create a cohesive design language. Read more in the [foundations](/salt/foundations) section.
...
### Object positioning: Justification
...
A guide that helps a team build a design solution for their project. Salt offers a set of composable components that are the building blocks of patterns.
...
A change (or series of changes) to Salt's default design decisions.
