...
For a full list of characteristics, refer to the [characteristic documentation](/salt/theme/characteristic-tokens).
...
For an overview of theming, refer to our [theming documentation](/salt/theme/index).
