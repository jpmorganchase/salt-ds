...
Salt is a pattern-driven system, meaning that we provide a set of simple, high-quality, context-agnostic [components](#component) and show you how to put them together in different ways, as patterns, to solve specific business problems. We recognize the need for UI solutions that are tailored to line of business, product or persona. Salt patterns provide you with solutions that you can use [out of the box](#OOTB) or easily modify to cater for nuances in your product experience. Each pattern has examples showing how you can put Salt components together following the Salt foundations. We also offer comprehensive supporting documentation to explain how to use the pattern, how to drive the pattern with business logic, and how to adjust it to suit your business case. Learn more in our [pattern documentation](/salt/patterns/index).
