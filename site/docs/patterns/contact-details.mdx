...
You can define contact details as links, making them interactive. This enables immediate communication to a contact from within your application.
 ...
 <Diagram
    src="/img/patterns/contact-details/contact-details-links.png"
    alt="Contact Details using Icon Descriptors"
...
If you’re displaying supplementary details, you can configure them to be collapsible.
 ...
 <Diagram
    src="/img/patterns/contact-details/contact-details-collapsible.png"
...
Use `StackLayout` to display the text elements underneath the header in a row.
 ...
 <Diagram
    src="/img/patterns/contact-details/contact-details-layout-1-list.png"
    alt="Contact Details in list using stack layout."
    border
  />

 <Diagram
    src="/img/patterns/contact-details/contact-details-layout-2-list.png"
    alt="Contact Details in list using stack layout."
    border
  />
