...
Contact details displays communication information for a person, company, distribution list or individual channel. This can include a name, a phone number or email address.
...
Contact details is comprised of an avatar and text elements. You can use a title as a name of a contact or a company.  optional details can be company names or company ID.
