...
We provide design guidance for using Salt button and layout components and the button bar template to achieve the pattern. You can also find implementation examples in the [storybook](https://storybook.saltdesignsystem.com/?path=/story/patterns-button-bar--button-bar).
