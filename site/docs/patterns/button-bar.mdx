...
We provide design guidance of how you can use Salt Button and Layout components and Button Bar template to achieve the pattern. Implementation examples can also be seen in the [storybook](https://storybook.saltdesignsystem.com/?path=/story/patterns-button-bar--button-bar).
