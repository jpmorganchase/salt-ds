...
<LivePreview componentName="patterns/metric" exampleName="Metric" />
...
- When the page needs a full dashboard shell, use [Analytical dashboard](/salt/patterns/analytical-dashboard).
