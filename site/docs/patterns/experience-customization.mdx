...
Use progressive disclosure to show 'Reset to default' only when the current step is no longer in its default state.
...
<GuidanceCallout type="positive" customPillText="Best practices">
**Explicit requirements**: Use the description area to clearly communicate that a selection is required to proceed. 
</GuidanceCallout>
