...
<Diagram
  src="/img/patterns/experience-customization/experience-customization-pattern-mandatory-preferences.png"
  srcDark="/img/patterns/experience-customization/experience-customization-pattern-mandatory-preferences-dark.png"
  alt="An example for mandatory preference for an experience customization pattern"
  border
  background="secondary"
/>
