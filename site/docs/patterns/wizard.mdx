...
## Layout
- Refer to [header block](/salt/patterns/header-block) pattern to have a standardized workflow title, consistent across steps, and step titles which vary per step.
