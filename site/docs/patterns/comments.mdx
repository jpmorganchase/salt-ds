...
<Diagram
  src="/img/patterns/comments/comments-pattern.png"
...
Use the Salt [`Avatar`](/salt/components/avatar) component’s categorical colors to differentiate authors; don’t use avatar color to imply status or severity.
