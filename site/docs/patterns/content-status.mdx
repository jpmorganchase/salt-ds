...
- Make sure that the solution fills the height and width of the container component.
...
We've used a [progress](/salt/components/progress) component in this example to help manage user expectations. If you know how long it takes to load or process content, use this to let your users know.
