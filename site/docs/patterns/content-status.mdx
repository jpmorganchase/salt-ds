...
description: "A content status communicates loading, empty, warning, error, and success states inside a container component. Use it to keep state messaging attached to the content the user is already working with."
...
- When the message should reach across the app, use Banner or Toast instead.
