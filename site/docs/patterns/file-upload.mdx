...
- Use the [`StackLayout`](/salt/components/layout/stack) to display the File drop zone, file upload items and text elements that make up file upload in a column.
- Use the [`StackLayout`](/salt/components/layout/flex) with a gap of 1 to position the text elements.
