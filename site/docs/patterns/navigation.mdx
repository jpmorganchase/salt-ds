...
For vertical navigation layout guidance, refer to the vertical navigation pattern.
...
<ImageSwitcher
  images={[
    {
      src: "/img/patterns/navigation/responsive_navigation_pane.png",
      alt: "Example showing a responsive navigation",
    },
    {
      src: "/img/patterns/navigation/responsive_navigation_pane_toggle_on.png",
