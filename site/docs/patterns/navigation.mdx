...
<Diagrams>
  ...
  >
    ### Vertical navigation
    You would normally place a [vertical navigation](/salt/patterns/vertical-navigation) in a sidebar, on the left side of the screen, or within a drawer. It can display many navigation items at once. Use it when:
