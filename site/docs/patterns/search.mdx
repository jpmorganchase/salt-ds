...
5. **Expand button:** An chevron icon button typically used to indicate that a dropdown menu can be expanded or collapsed.
...
<Image
  ...
  alt="Example of search with recnet searches in dropdown"
/>
