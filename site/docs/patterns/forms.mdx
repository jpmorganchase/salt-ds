...
You can display a form as a dedicated page, within a dialog, nested into drawers or within a side panel. Independently of how a form is displayed, the following elements are generally found in a form:
...
For unrelated columns, align each column to its own layout grid, with the separator attached to the right margin of the preceding column. This ensures adequate separation between columns and separators.
...
<Diagram
  ...
  caption="Example of a multicolumn form embedded in a dedicated page."
  border
/>
...
### Primary field on primary and secondary backgrounds

Primary field on primary background is effective for a form that:
...
Use primary field on secondary background to display the form as a secondary priority.

<Diagram
  src="/img/patterns/forms/form-primary-field.png"
  alt="Examples of primary field on primary and secondary backgrounds."
  caption="Examples of primary field on primary (left) and secondary (right) backgrounds."
  border
/>

### Secondary field on primary and secondary backgrounds

Secondary field on primary background is effective for a form that:

- Is used by experts/is frequently used.
- Is compact and data-dense.
- Has multiple sections/columns.

Use secondary field on secondary background as an alternate option, but not a common combination.

<Diagram
  src="/img/patterns/forms/form-secondary-field.png"
  alt="Examples of secondary field on primary and secondary backgrounds."
  caption="Examples of secondary field on primary (left) and secondary (right) backgrounds."
  border
/>
