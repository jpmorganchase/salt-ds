...
To keep busy forms as simple as possible, choose a combination of these fills to achieve a visual hierarchy. Rather than adding more background colors, if you need further visual separation, use:
1. [Headings](#headings)
...
<ExampleContainer type="positive" label="Best practices">
  You can combine labels and questions in the same form (although not on the same form field). In this case, use top placed labels.
</ExampleContainer>
