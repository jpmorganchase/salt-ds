...
field, announce a concise error summary, and move focus to the first field that
needs attention. While a submission is pending, make progress clear and avoid
