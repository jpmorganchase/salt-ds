...
<ImageSwitcher
  images={[
    { src: "/img/patterns/forms/form-sections.png", alt: "" },
    { src: "/img/patterns/forms/form-sections-spacing.png", alt: "" },
  ]}
  label="Show spacing"
/>
...
<ImageSwitcher
  images={[
    ...
    { src: "/img/patterns/forms/form-multiple-columns-wrapped.png", alt: "" },
  ]}
  label="Wrap columns"
/>
