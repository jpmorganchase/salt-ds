...
Occasionally it’s necessary to display a data-rich form in a small viewport without reducing the component density. In this case, spacing can be reduced or removed to achieve a compact form layout.
