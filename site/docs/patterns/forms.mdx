...
<Diagram
  src="/img/patterns/forms/editable.png"
  alt="Example showing an editable form."
  border
/>
...
<Diagram
  src="/img/patterns/forms/readonly-summary.png"
...
A button bar provides next steps when a user reaches the end of the form, such as navigating to previous or next steps, submitting their form or cancelling changes. See more guidance in the [button bar pattern](/salt/patterns/button-bar).
...
These use accordions to progressively reveal fields in long, dense forms. Sections aren't mutually exclusive: users can expand multiple to compare.
