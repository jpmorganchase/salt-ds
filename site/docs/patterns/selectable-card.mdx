...
- By default, titles and supporting content are left aligned inside the card when using left-to-right languages like English. For text alignment alternatives, refer to the Salt typography foundation.
</ExampleContainer>
