...
- Should be easy to select on mobile, with a large tap target for quick interaction.
...
Use checkboxes in selectable cards when your users need to make multiple selections from a list of options.
