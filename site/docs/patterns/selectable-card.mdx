...
4. **Selection indicator**: Display a radio button (single-select) or checkbox (multi-select) within the card to clearly convey selection state. Supporting text may be included to help users decide.<Diagram
