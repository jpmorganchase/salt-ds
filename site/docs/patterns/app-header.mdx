...
- Use a [navigation item](/salt/components/navigation-item) to build the horizontal page navigation, as explained in the [navigation pattern](./navigation).
- Use the flex layout component with justify set to `space-between` to position the brand logo, navigation and utilities.
