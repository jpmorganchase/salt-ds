    ...
    starterScaffold:
      sourceUrls:
        [
          ...
          "/salt/components/layouts/border-layout/usage",
          "/salt/components/layouts/grid-layout/usage",
          "/salt/patterns/metric",
        ]
      template: "analytical-dashboard"
      semantics:
        regions: ["dashboard-header", "key-metrics", "fixed-panel", "main-body"]
        requiredRegions: ["main-body"]
        optionalRegions: ["dashboard-header", "key-metrics", "fixed-panel"]
        buildAround:
          [
            "Dashboard header",
            "Key metrics",
        ...
        preserveConstraints:
          [
            ...
            "Use BorderLayout only for the top-level layout and use GridLayout to manage the layout and responsiveness of the main content area.",
          ]
---
...
- When the content is mostly a single simple metric, use [Metric](../metric).
