...
- We recommend cards are styled with the `--salt-container-primary-background`, and the application with `--salt-container-secondary-background`. This is the most effective presentation of data providing the highest contrast between visualisations and their immediate backgrounds.
