...
The pattern is a form that displays relevant fields for a user-selected location. Future versions of the pattern will cover the use of APIs, autocompletion and enhanced support for more locations.
