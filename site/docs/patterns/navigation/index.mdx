...
<Diagrams>
  <Diagram
    ...
    contentPosition="top"
  >
    ### Horizontal navigation You would normally use a horizontal navigation
    within an application header, at the top of a page. Use it when you need a
    navigation that: - Is always displayed in a prominent and consistent
    location. - Affords movement from one set of content to another regardless
    of where the user is in the website or app.
  </Diagram>
  <Diagram
    ...
    contentPosition="top"
  >
    ### Vertical navigation You would normally place a [vertical
    navigation](/salt/patterns/vertical-navigation) in a sidebar, on the left
    side of the screen, or within a drawer. It can display many navigation items
    at once. Use it when: - You need to show many top-level views. - You have
  ...
  <Diagram
    ...
    contentPosition="top"
  >
    ### Combined navigation Combine both horizontal and vertical navigation when
    users need to: - Navigate between multiple apps with horizontal navigation,
    and multiple pages within each app with vertical navigation. - Navigate
...
<ImageSwitcher
  images={[
    {
      src: "/img/patterns/navigation/multi_level.png",
      alt: "Example showing a multi level navigation collapsed",
    },
    {
      src: "/img/patterns/navigation/multi_level_toggle_on.png",
      alt: "Example showing a multi level navigation expanded",
    },
  ]}
...
<ImageSwitcher
  images={[
    {
      src: "/img/patterns/navigation/combined_navigation_example.png",
      alt: "Example showing a combined navigation",
    },
    {
      src: "/img/patterns/navigation/combined_navigation_toggle_on.png",
      alt: "Example showing a combined navigation with icons",
    },
  ]}
  label="With icons"
/>
...
<ExampleContainer type="positive" customPillText="Best practices">
  ...
  responsive, or just for the content area if it is. - Use [Salt
