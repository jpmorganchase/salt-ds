...
<ExampleContainer type="positive" customPillText="Best practices">
  Use horizontal navigation when you have fewer than eight items.
  Otherwise, consider a vertical group of items.
</ExampleContainer>
...
<ExampleContainer type="positive" customPillText="Best practices">
  ...
  - Use [Salt breakpoints](/salt/foundations/responsiveness#breakpoints) to determine how
