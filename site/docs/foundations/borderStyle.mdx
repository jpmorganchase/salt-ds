...
Dotted borderStyle is typically used to indicate a temporary or incomplete process or content block, an example of this is the track between incomplete steps in the [Stepper](../components/stepper) component.
