...
Dashed border style is typically used to visually indicate drag/drop targets, such as the File Drop Zone component

## Dotted

Dotted borderStyle is typically used to indicate a temporary or incomplete process or content block, an example of this is the track between incomplete steps in the Stepper component.
