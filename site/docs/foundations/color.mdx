...
Colors can be used to communicate meaning, establish visual hierarchy, and differentiate Salt products from others, all while ensuring a cohesive and accessible experience. Colors are divided into several categories to communicate several concepts across the Salt design system.

The colors on this page reference the Salt color library. If you’re using the Salt Next theme please refer to the separate color palette and listed guidance on the [Theming page](/salt/theming/index). 
