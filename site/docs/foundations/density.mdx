...
Low density is optimized for data or content-light interfaces. It's ideal for marketing, communications, or onboarding experiences. In constrast to 'high density', low density is intended for infrequently used applications by inexperienced users.
