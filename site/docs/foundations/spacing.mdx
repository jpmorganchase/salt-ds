...
| Token                | Formula | High Density      | Medium      | Low      | Touch      |
| -------------------- | ------- | ----------------- | ----------- | -------- | ---------- |
...
For spacing purposes, separators are considered as a type of content and therefore spaced consistently. This means that:
