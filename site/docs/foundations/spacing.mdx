...
Standard spacing between items in a horizontal configuration is typically 300, which aligns with the design systems responsive layout grid, and will automatically adjust depending on what density you're using.
