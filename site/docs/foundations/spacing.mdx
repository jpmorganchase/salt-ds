...
Standard spacing between items in a horizontal configuration is typically 300, which aligns with the design systems responsive layout grid and sets margins and gutters at --salt-spacing-300.  
