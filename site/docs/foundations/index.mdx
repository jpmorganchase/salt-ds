...
<QuickLinks
  ...
  links={[
    ...
    },
    {
      title: "Border style",
      description:
        "Provides a standardized set of design tokens to ensure consistent border styles across all components and patterns.",
      href: "./borderstyle",
    },
    {
      title: "Color",
    ...
    },
    {
      ...
      description:
        "Data visualization presents information in a visual form that's easy to understand.",
