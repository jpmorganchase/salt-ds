  ...
  links={[
    {
      title: "Assets",
      description:
        "Find icons and country symbols to visually represent actions, objects, concepts, and geographical identities. Icons simplify specific actions or objects. Country symbols identify countries for geographical context",
      href: "./assets",
    },
    {
      title: "Color",
    ...
    },
    {
      title: "Elevation",
      description:
        "Elevation uses shadow and z-index to organize content layers. Shadow adds depth and realism, while z-index controls the stacking order, making it easy to distinguish between layers.",
      href: "./elevation",
    },
    {
      title: "Modes",
