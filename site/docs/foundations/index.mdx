...
<QuickLinks
  ...
  links={[
    ...
    },
    {
      title: "Border style",
      description:
        "The border style foundation provides a standardized set of design tokens to ensure consistent border styles across all components and patterns. Borders help to define hierarchies of control by segregating different components or content areas.",
      href: "./borderStyle",
    },
    {
      title: "Color",
