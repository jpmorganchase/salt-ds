...
Understanding the principles of chart anatomy is important to learning how the different parts of Salt charts work. For example, axis title, axis label, legends and grid lines.
