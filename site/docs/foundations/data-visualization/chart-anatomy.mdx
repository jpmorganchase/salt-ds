...
When you have more legend items than available to fit in the height of the chart, default pagination will be used. This is should not be confused with the Salt Pagination component.
