...
For detailed information on how to apply duration in design and the use cases, please refer to the [Understanding Duration in User Experience - Insights from the Salt Design System blog post](https://go/salt-ds-internal/salt/news/blogs/20250402-duration#). (Internal users only)
