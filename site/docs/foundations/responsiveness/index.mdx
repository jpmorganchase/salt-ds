...
- [Border layout](/salt/components/layout/border-layout)
- [Flex layout](/salt/components/layout/flex-layout)
- [Grid layout](/salt/components/layout/grid-layout)
- [Parent-child layout](/salt/components/layout/parent-child-layout)
- [Split layout](/salt/components/layout/split-layout)
- [Stack layout](/salt/components/layout/stack-layout)
