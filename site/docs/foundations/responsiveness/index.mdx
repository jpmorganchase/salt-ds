...
- [Border layout](/salt/components/layout/border)
- [Flex layout](/salt/components/layout/flex)
- [Grid layout](/salt/components/layout/grid)
- [Parent-child layout](/salt/components/layout/parent-child)
- [Split layout](/salt/components/layout/split)
- [Stack layout](/salt/components/layout/stack)
