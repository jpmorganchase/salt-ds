...
For guidance on breakpoints and column layouts for mobile and tablet devices, see the [Small screens](/salt/foundations/responsiveness/small-screens) documentation.
