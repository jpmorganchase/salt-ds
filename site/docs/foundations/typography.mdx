...
/>
| Token | Light mode | Dark mode | | --- | --- | --- | | `text-primary-foreground`
| `color-gray-900` | `color-white` | | `text-secondary-foreground` | `color-gray-200`
| `color-gray-70` |
...
<ExampleContainer type="negative">
  ...
  be able to perceive the difference, and screen readers do not announce colors to
  non-sighted readers.
</ExampleContainer>
