...
| ----------------------------- | ------------------------- | ---------------- | --------------- |
| `--salt-foreground-primary`   | Text/Primary/Foreground   | `color-gray-900` | `color-white`   |
| `--salt-foreground-secondary` | Text/Secondary/Foreground | `color-gray-200` | `color-gray-70` |
