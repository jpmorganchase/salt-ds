...
<Image src="/img/foundations/typography-style-display.svg" alt="Graphical representation of Display styles" />

#### Display
Display styles are primarily reserved for representing key metrics and mastheads. 

<Image src="/img/foundations/typography-style-headings.svg" alt="Graphical representation of Heading styles" />

#### Headings
Headings provide varying levels of typographic hierarchy.

<Image src="/img/foundations/typography-style-body-label.svg" alt="Graphical representation of Body and Label styles" />
#### Body
