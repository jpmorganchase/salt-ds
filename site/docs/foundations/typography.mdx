...
Legibility and accessibility are key considerations within the design system. With this in mind, each mode provides two color options: primary and secondary. Both of these options are selected from the neutral palette. These colors are consistently applied throughout the design system.
