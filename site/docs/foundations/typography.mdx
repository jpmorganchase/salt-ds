...
| --- | --- | --- | 
| `text-primary-foreground` | `color-gray-900` | `color-white` | 
| `text-secondary-foreground` | `color-gray-200` | `color-gray-70` |
...
As with most aspects of the design system, type conforms to [density](density). Each style grows proportionately to align with the elements around it. Line height and the spaces between blocks of text also adhere to density.
