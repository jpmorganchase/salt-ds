...
Z-index is a CSS property that controls how certain components stack on top of each other. The stack order is defined by an element with greater z-index appearing on top of an element with a lower stack order.
