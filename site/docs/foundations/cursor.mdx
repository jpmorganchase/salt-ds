...
| Token                    | Purpose                                                                                         | Value     |
| ------------------------ | ----------------------------------------------------------------------------------------------- | --------- |
| `--salt-cursor`          | The default cursor state when hovering over an interactable component                           | pointer   |
...
| `--salt-cursor-grabbing` | Active state of a draggable object                                                              | grabbing  |
...
| `--salt-cursor-readonly` | Readonly states                                                                                 | text      |
