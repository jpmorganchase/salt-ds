...
import JPMLogo from "@site/static/img/design-getting-started/jpmIcon.svg";
import Globe from "@site/static/img/design-getting-started/globe.svg";
...
import { InlineCard, CardProps } from "@site/src/components/card/Card";
import Content from "@site/src/components/content/Content.tsx";
import { PrintIcon } from "@salt-ds/icons";
import { SaltProvider } from "@salt-ds/core";
import DesignCards, { DesignCard } from "./_designing/DesignCards.tsx";
import IconsTable, { DensityIcon } from "./_designing/IconsTable.tsx";

import styles from "./_designing/designing.module.css";
...
<InlineCard
  ...
  description={
    <p>
      ...
      <span className={styles.strong}>@jpmorgan_salt</span> handle in the Figma
      Community.
    </p>
  }
...
:::info Migrating your workspace in Figma
...
<DesignCard
  img={Assets1}
  altText="Screenshot of Figma's assets panel displaying the 'Salt: Components Light' library"
>
...
<DesignCard
  img={Assets2}
  altText="Screenshot of a light mode Button component being dragged out of Figma's assets panel"
>
...
<DesignCard
  img={Assets3}
  altText="Screenshot of the word 'button' being searched for in the Figma assets panel and Salt components with matching names being displayed"
>
...
<DesignCard
  img={Assets4}
  altText="Screenshot of the Figma's contextual panel for Salt's Button component"
>
...
| ---------------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| 1X <span className={styles.colored}>(default)</span> | <DensityIcon density="high" icon={<PrintIcon />}>12px</DensityIcon>         | <DensityIcon density="medium" icon={<PrintIcon />}>12px</DensityIcon>         | <DensityIcon density="low" icon={<PrintIcon />}>14px</DensityIcon>         | <DensityIcon density="touch" icon={<PrintIcon />}>16px</DensityIcon>         |
| 2X                                                   | <DensityIcon density="high" icon={<PrintIcon size={2}/>}>20px</DensityIcon> | <DensityIcon density="medium" icon={<PrintIcon size={2}/>}>24px</DensityIcon> | <DensityIcon density="low" icon={<PrintIcon size={2}/>}>28px</DensityIcon> | <DensityIcon density="touch" icon={<PrintIcon size={2}/>}>32px</DensityIcon> |
| 3X                                                   | <DensityIcon density="high" icon={<PrintIcon size={3}/>}>30px</DensityIcon> | <DensityIcon density="medium" icon={<PrintIcon size={3}/>}>36px</DensityIcon> | <DensityIcon density="low" icon={<PrintIcon size={3}/>}>42px</DensityIcon> | <DensityIcon density="touch" icon={<PrintIcon size={3}/>}>48px</DensityIcon> |
