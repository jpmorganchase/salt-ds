...
| Salt DS Themes                  | This library includes all typography and effect styles as well as all color, size, spacing variables needed for the themes available within the components and patterns library. All variables are reflective of the design tokens in code.  |
