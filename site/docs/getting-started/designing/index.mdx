...
If you're a JPMorganChase employee and would like to use Salt's Chase theme, please refer to our internal documentation for [Chase theme setup and installation](go/saltds-chase-theme)(internal only).

<Callout
  status="warning"
  title="Salt DS JPM Brand Colors, Legacy (UITK) Colors libraries"
>
...
| Library                      | Description                                                                                              |
| ---------------------------- | -------------------------------------------------------------------------------------------------------- |
| Salt DS JPM Brand Colors     | This library provides variables for each foundational color needed with the Salt DS JPM Brand theme.     |
