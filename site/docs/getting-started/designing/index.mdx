...
| Library                         | Description                                                                                                                            |
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Salt DS Components and Patterns | This library includes all Salt DS components and patterns representative in code and pattern documented on site. To use Salt components and patterns directly, please install this library. |
| Salt DS Themes                  | This Library includes all typography and effect styles as well as all color and dimension variables needed for the themes available within the components and patterns library. All variables are reflective of the design tokens in code.  |
