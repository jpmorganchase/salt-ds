...
<Callout
  status="warning"
  title="Salt DS JPMorgan Colors, Legacy (UITK) Colors libraries"
>
...
| Library                      | Description                                                                                              |
| ---------------------------- | -------------------------------------------------------------------------------------------------------- |
| Salt DS JPMorgan Colors     | This library provides variables for each foundational color needed with the Salt DS JPMorgan theme.     |
