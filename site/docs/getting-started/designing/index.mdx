...
<Callout title="New Salt DS Figma libraries are live! Plan Your Migration">

Plan your migration now to ensure a seamless transition before the existing libraries are unpublished. We're here to help!
...
- Unpublishing : Existing libraries removed by end of day, February 28th.

For more details, read our Migration guide Have questions? Join our [office hours](https://go/salt-ds-internal/support/office-hours) or [contact us](https://www.saltdesignsystem.com/salt/support-and-contributions/index)
...
<GridLayout columns={{ xs: 1, sm: 2 }}>
  ...
  <OverviewCard           
    ...
    url="https://www.figma.com/files/858076651348346387/project/72279506?fuid=1055082680458678350"
...
4\. In the search field, type "Salt DS" to see the Salt DS library.
...
5\. Click the "Add to file" button to include the Salt DS library in your design file. For details on each library, see the section below.
...
Salt offers six libraries in Figma. Install the library that best suits your purpose.

<div className="saltSite-util-space-below-2x">

| Library                         | description                                                                                                                                |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Salt DS Components and Patterns | This library includes Salt DS components and patterns. To use Salt components and patterns directly, please install this library.          |
| Salt DS Themes                  | This library includes styles such as foundations, color, typography, and a responsive grid.                                                |
| Salt DS Assets                  | This library offers Salt Icons and Country symbols.                                                                                        |
| Salt DS JPM Brand color         | This library provides color variables for the Salt DS JPM Brand theme.                                                                     |
| Salt DS Legacy(UITK) Colors     | This library provides color variables for the Salt DS Legacy (UITK) theme.                                                                 |
...
If you are migrating from other libraries, including Salt (Next), Salt Light, Dark libraries, and UITK, please refer to our [migration guide.](https://go/salt-ds-internal/migration-strategies/new-salt-ds-figma)(JPMC employees only)
...
<OverviewCard           
    title="Office hours"
    url="https://go/salt-ds-internal/support/office-hours"
    footerText="Enroll office hours"
    keylineColor="blue"
    >
Enroll in our office hours for live assistance and guidance. (JPMC employees only).
  </OverviewCard>
