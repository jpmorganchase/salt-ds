...
| Figma 'Template' Component | [Salt Component](/salt/components/index/) and [Salt Pattern](/salt/patterns/index/) | A Figma component that comprises of nested components and is designed to be detached. Basic configuration props enable you to define the best starting point before detaching.         |
