...
| -------------------------- | ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | 
| Figma Component            | Salt Component                             | A Figma component that shouldn’t be detached and is configured by props, kept as close as possible to the coded component. May contain ‘swap’ elements for additional composability.   | 
| Figma 'Template' Component | Salt Component and Salt Pattern            | A Figma component that comprises of nested components and is designed to be detached. Basic configuration props enable you to define the best starting point before detaching.         |
| Figma Sticker              | Salt Component and Salt Pattern            | Figma examples built by Salt or App teams with Salt DS. Provided as frames, not components, that can be copied and pasted from our Sticker sheet file into your projects as a starter. | 
