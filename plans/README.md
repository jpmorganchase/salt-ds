...
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | -------- | -------------- | ------------ | ---------------------------------------------------------------------- |
| [001](./001-build-salt-ai-knowledge-platform.md)     | Build the versioned Salt AI knowledge platform, CLI scanner, docs channels, samples, and optional MCP           | P1       | L, multi-phase | —            | TODO                                                                   |
...
| ---- | ------------------------------------------------------------------- | ---------- | ------------------------------------- | ------------------------ | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 00a  | Publication fence, package namespaces, ordinary baseline            | —          | BLOCKED — dispatch checkpoint pending | set after plan set lands | —              | embargo/workflow-policy receipts, package-namespace control receipt, ordinary-baseline schema/receipt/artifact digests                                                                                                                                                                                                                            |
