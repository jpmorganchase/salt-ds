...
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | -------- | -------------- | ------------------- | ---------------------------------------------------------------------------- |
| [001](./001-build-salt-ai-knowledge-platform.md)     | Build the Salt AI knowledge platform, CLI scanner, docs channels, samples, and optional MCP release candidate   | P1       | L, multi-phase | —                   | IN PROGRESS — Unit 07 reproducibility repair                                 |
...
| 07   | Current-spec MCP candidate and provisional ship/omit recommendation | 06g        | IN PROGRESS — reproducibility repair          | 023cb7f382b74067d2ac5f524d24065481ea1b7c | —                                        | Original disposition remains `omit`; clean CRLF/LF selected-graph parity and successor evidence are pending. evidence-index=plans/evidence/001/07.json@sha256:05318e82fbfcc80c6e48f8bd8d1564ba7459357e7ac7c96472564c155e881d0c                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
