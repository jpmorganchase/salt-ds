...
Improved single-select `InteractableCardGroup` keyboard navigation. Arrow keys skip disabled cards and no longer scroll the page, and Tab moves focus to the first enabled card when no enabled card is selected.
