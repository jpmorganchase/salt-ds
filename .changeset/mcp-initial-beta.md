...
- `@salt-ds/mcp` packages the canonical Salt Design System MCP server with the beta six-tool workflow surface for repo-aware Salt context, repo bootstrap, create, review, migrate, and upgrade guidance.
