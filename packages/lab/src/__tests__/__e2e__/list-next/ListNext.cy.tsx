...
describe("GIVEN a list", () => {
  describe("GIVEN a single select list", () => {
    describe("WHEN uncontrolled", () => {
      ...
      it("THEN allows a single item to be selected", () => {
        cy.mount(<SingleSelectList />);
      ...
      it("THEN keep its selected item when the same item is selected", () => {
        cy.mount(<SingleSelectList />);
      ...
      describe("WHEN displayedItemCount", () => {
        const itemHeight = 36;
      ...
      describe("WHEN keyboard navigation and interactions", () => {
        it("THEN select list item on Space or Enter key", () => {
          cy.mount(<SingleSelectList />);
        ...
        describe("WHEN on first list keyboard focus", () => {
          it("THEN focus and select first list item", () => {
            cy.mount(<SingleSelectList />);
        ...
        describe("WHEN an item was previously focused", () => {
          it("THEN re-focus on previously focused item", () => {
            cy.mount(<SingleSelectList />);
        ...
        describe("WHEN on Home key press", () => {
          it("THEN focus on first list item", () => {
            cy.mount(<SingleSelectList />);
        ...
        describe("WHEN on End key press", () => {
          it("THEN focus on last list item", () => {
            cy.mount(<SingleSelectList />);
        ...
        describe("WHEN an item was previously interacted with mouse", () => {
          it("THEN re-focus on said item", () => {
            cy.mount(<SingleSelectList />);
