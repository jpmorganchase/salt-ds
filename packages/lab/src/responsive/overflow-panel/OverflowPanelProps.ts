...
export interface OverflowPanelProps extends HTMLAttributes<HTMLElement> {
  /**
   * Trigger element.
   * Needs to be able to hold a ref. If you are passing a custom component remember to spread the props
   * over your component.
   * If you want pass a ref instead and have control over opening/closing the cascading menu,
...
export interface OverflowPanelItemProps extends HTMLAttributes<HTMLElement> {
  delay?: number;
  closeMenu: () => void;
  flipped: boolean;
  ...
  onItemClick: (sourceItem: any, evt: any) => void;
