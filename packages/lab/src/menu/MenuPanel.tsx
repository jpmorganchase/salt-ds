...
export const MenuPanel = forwardRef<HTMLDivElement, MenuPanelProps>(
  function MenuPanel(props, ref) {
    ...
    const { getItemProps, openState, getFloatingProps, refs, getPanelPosition, context, elementsRef, activeIndex } =
      useMenuContext();

    const handleRef = useForkRef<HTMLDivElement>(ref, refs.setFloating);

    return (
      <MenuPanelContext.Provider value={{ activeIndex, getItemProps }}>
