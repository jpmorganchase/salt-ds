...
export interface InlaidPanelContentProps extends ComponentPropsWithRef<"div"> {
  /**
...
export const InlaidPanelContent = forwardRef<
  HTMLDivElement,
  InlaidPanelContentProps
>(function InlaidPanelContent(props, ref) {
