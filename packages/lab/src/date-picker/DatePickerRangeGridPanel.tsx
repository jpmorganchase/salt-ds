...
export const DatePickerRangeGridPanel = forwardRef(function DatePickerRangeGridPanel<
...
>(props: DatePickerRangeGridPanelProps<TDate>, ref: React.Ref<HTMLDivElement>) {
  ...
  const [uncontrolledDefaultVisibleMonth] = useState(() => {
    const validDate: TDate = selectedDate?.startDate && dateAdapter.isValid(selectedDate.startDate)
