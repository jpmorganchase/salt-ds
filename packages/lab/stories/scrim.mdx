...
import * as ScrimStories from "./scrim.stories";

<Meta of={ScrimStories} />
...
<Canvas>
  <Story of={ScrimStories.Closable} />
</Canvas>
...
<Canvas>
  <Story of={ScrimStories.WithContainer} />
</Canvas>
