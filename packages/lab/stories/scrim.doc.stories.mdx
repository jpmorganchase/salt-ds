...
You can display a Scrim within a container such as a [Card](/docs/documentation-core-card--page) or to temporarily block interaction while the container content is loading or unavailable.
