...
By default, the Banner is non-dismissible, If you want to make the Banner dismissible, then you should add the BannerCloseButton component.

<Canvas>
  <Story id="lab-banner--with-close" />
</Canvas>
