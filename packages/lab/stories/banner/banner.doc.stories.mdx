...
<Canvas>
  <Story id="lab-banner--emphasized" />
</Canvas>

## Dismissible

By default, the Banner is non-dismissible, If you want to make the Banner dismissible, then you should display the Banner conditionally and add the BannerActions component with an onClick handler that will update the conditional param.
...
<Canvas>
  <Story id="lab-banner--controlled" />
</Canvas>
