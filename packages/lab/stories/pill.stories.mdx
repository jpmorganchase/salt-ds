...
import { UserBadgeIcon } from "@jpmorganchase/icons";
import { Pill, SelectablePill } from "@jpmorganchase/lab";

<Meta title="Lab/Pill/Doc" component={Pill} />
...
**Related components**  
**Similar to:** [Badge](/?path=/docs/toolkit-2-0-badge),
[Checkbox](/?path=/docs/toolkit-2-0-checkbox),
[Link](/?path=/docs/toolkit-2-0-link),
[Switch](/?path=/docs/toolkit-2-0-switch),
[ToggleButton](/?path=/docs/toolkit-2-0-togglebutton)  
**Uses:** [Button](/?path=/docs/toolkit-2-0-button),
[Checkbox](/?path=/docs/toolkit-2-0-checkbox),
[Icon](/?path=/docs/toolkit-2-0-icon),
[Tooltip](/?path=/docs/toolkit-2-0-tooltip)
...
a result of user inputs or other factors. This Pill, for example, may be used to
...
alongside a complex filter panel—or within an input control such as
...
<Canvas>
  <Story id="toolkit-pill--controlled-pill" />
</Canvas>
