...
The Badge component provides a small status descriptor for UI elements. It is a small circle containing a number or a few characters that typically appears in one of the corners of the UI element.

## Icon Badge

The default UI element is MessageIcon
...
<Canvas>
  <Story name="Custom Badge Styling">
    <CustomStyling />
  </Story>
</Canvas>
