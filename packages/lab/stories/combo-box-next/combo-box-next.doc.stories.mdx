...
<Canvas>
  <Story id="lab-combo-box-next--variant" />
</Canvas>
...
You can set Combo Box to a read-only state. The value text can’t be edited in this state, but it can be highlighted and copied.

<Canvas>
  <Story id="lab-combo-box-next--readonly" />
</Canvas>
