...
Additionally, the display of list items can be customised to visually assist users, like the rendering flag icons next to the name of countries seen below. You can achieve this by passing an `itemRenderer` prop.
