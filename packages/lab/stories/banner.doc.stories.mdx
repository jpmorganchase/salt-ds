...
## How does it behave in its layout?

By default, the Banner is dismissable. Your users can click the embedded "X" button to close it. If you want to make Banner non-dismissible,
just hide the "X" button.
