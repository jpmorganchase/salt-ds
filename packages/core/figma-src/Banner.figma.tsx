...
// Info - https://www.figma.com/design/7Fh5JbUUM84pYwLt9tpJh2/Salt-DS-Components-and-Patterns?m=auto&node-id=7997-77923
// Need to split to 2 blocks - see issue https://github.com/figma/code-connect/issues/200#issuecomment-2457330375
figma.connect(
  Banner,
  "https://www.figma.com/design/7Fh5JbUUM84pYwLt9tpJh2/Salt-DS-Components-and-Patterns?node-id=7997-77923",
  {
    ...
    example: (props) => (
      <Banner status="info" variant={props.variant}>
        <BannerContent>
          <StackLayout gap={1}>
            <Text>
...
// Error - https://www.figma.com/design/7Fh5JbUUM84pYwLt9tpJh2/Salt-DS-Components-and-Patterns?m=auto&node-id=7997-77972
// Need to split to 2 blocks - see issue https://github.com/figma/code-connect/issues/200#issuecomment-2457330375
figma.connect(
  Banner,
  "https://www.figma.com/design/7Fh5JbUUM84pYwLt9tpJh2/Salt-DS-Components-and-Patterns?node-id=7997-77972",
  {
    variant: { "Show title": true },
    props: {
      // inlineContent: figma.instance("🔁 Inline content"), // Icon next to the close button
    ...
    example: (props) => (
      <Banner status="error" variant={props.variant}>
        <BannerContent>
          <StackLayout gap={1}>
            <Text>
              <strong>{props.title}</strong>
...
figma.connect(
  Banner,
  "https://www.figma.com/design/7Fh5JbUUM84pYwLt9tpJh2/Salt-DS-Components-and-Patterns?node-id=7997-78021",
  {
    variant: { "Show title": true },
    props: {
      // inlineContent: figma.instance("🔁 Inline content"), // Icon next to the close button
    ...
    example: (props) => (
      <Banner status="warning" variant={props.variant}>
        <BannerContent>
          <StackLayout gap={1}>
            <Text>
              <strong>{props.title}</strong>
