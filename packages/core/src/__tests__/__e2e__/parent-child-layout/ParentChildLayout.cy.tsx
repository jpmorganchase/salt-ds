...
describe("GIVEN a ParentChildLayout", () => {
  ...
  describe("WHEN collapseAtbreakpoint is provided", () => {
    it("THEN it should be uncollapsed when the current breakpoint is greater than the target breakpoint", {
      viewportHeight: 900,
      viewportWidth: 1921,
    }, () => {
    ...
    it("THEN it should be collapsed when the current breakpoint less than or equal to the target breakpoint", {
      viewportHeight: 900,
      viewportWidth: 1920,
    }, () => {
      cy.mount(<Default collapseAtBreakpoint="lg" />);
  ...
  describe("WHEN custom breakpoints are provided", () => {
    ...
    it("THEN it should be collapsed when the current less than or equal to the target breakpoint", {
      viewportHeight: 900,
      viewportWidth: 1920,
    }, () => {
      cy.mount(
  ...
  describe("WHEN collapsed", () => {
    it("THEN it should display the Child by default", {
      viewportHeight: 900,
      viewportWidth: 600,
    }, () => {
      cy.mount(<Default />);
    ...
    it("THEN it should display the Parent component when passed as the visibleViewProp", {
      viewportHeight: 900,
      viewportWidth: 600,
    }, () => {
