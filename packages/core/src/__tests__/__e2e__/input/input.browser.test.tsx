...
describe("GIVEN an Input", () => {
  ...
  describe("WHEN rendered as an uncontrolled component", () => {
    it("THEN it should render with the specified defaultValue", async () => {
  ...
  describe("WHEN rendered as a controlled component", () => {
    it("THEN it should render with the specified value", async () => {
  ...
  describe("WHEN the Input is disabled", () => {
    it("THEN should render disabled", async () => {
  ...
  describe("WHEN the Input is read only", () => {
    it("THEN should render read only", async () => {
    ...
    describe("AND empty", () => {
      it("THEN should render an emdash by default", async () => {
      ...
      it("THEN should render a custom marker", async () => {
