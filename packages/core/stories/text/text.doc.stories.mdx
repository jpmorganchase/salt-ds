...
import { CharacteristicUsage, CSSClassTable } from "css-variable-docgen-components";
...
```
import { Text, H1, H2, H3, H4, Label, Display1, Display2, Display3, Notation, Action} from "@salt-ds/core";
```
