...
import * as SaltProviderStories from "./salt-provider.stories";

<Meta of={SaltProviderStories} />
...
<Canvas>
  <Story of={SaltProviderStories.Default} />
</Canvas>
...
<Canvas>
  <Story of={SaltProviderStories.NestedProviders} />
</Canvas>
