...
- An icon should be put before the text if it is further describing the button's action, such as upload, submit, play, or do. This can be useful in busy environments where an additional description can improve speed in locating actions.
