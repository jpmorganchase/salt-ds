...
.uitk-newapp .uitkButton-primary.uitkButton-final-execution {
  ...
  --button-textColor: var(--uitk-actionable-final-foreground);
  --button-textColor-active: var(--uitk-actionable-final-foreground-active);
  --button-textColor-disabled: var(--uitk-actionable-final-foreground-disabled);
  --button-textColor-hover: var(--uitk-actionable-final-foreground-hover);
