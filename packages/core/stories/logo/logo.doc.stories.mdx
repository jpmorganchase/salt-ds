...
import { Logo, LogoImage, LogoSeparator, Text } from "@salt-ds/core";
import {
  CharacteristicUsage,
  CSSClassTable,
...
Logo component gives users the flexibility of including the elements they need to meet their design specs. It can contain elements like SVG, LogoImage, LogoSeparator and [Text component](?path=/docs/documentation-core-text--page) or other elements like SVG image.
...
The Logo component can be used to provide a link e.g., to a Homepage. Simply wrap the component in a [Link](?path=/story/documentation-core-link--page) component and specify the destination.
