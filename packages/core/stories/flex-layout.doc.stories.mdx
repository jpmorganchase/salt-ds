...
<Meta
  title="Documentation/Layout/FlexLayout"
...
For layouts where you need to control the two dimensions, see [Grid layout](?path=/docs/documentation-layout-gridlayout--page).
...
You want your layout to have a constant direction. In this case we recommend you having a look at [Stack layout](?path=/docs/documentation-layout-stacklayout--page) or [Flow layout](?path=/docs/documentation-layout-flowlayout--page).
...
<Canvas>
  <Story id="layout-flexlayout--flex-layout-with-separators" />
</Canvas>
...
<Canvas>
  <Story id="layout-flexlayout--flex-layout-using-responsive-props" />
</Canvas>
...
- [Stack layout](?path=/docs/documentation-layout-stacklayout--page)
- [Flow layout](?path=/docs/documentation-layout-flowlayout--page)
