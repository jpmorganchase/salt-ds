...
import * as FlexItemStories from "./flex-item.stories";

<Meta of={FlexLayoutStories} />
...
<Canvas>
  <Story of={FlexLayoutStories.Default} />
</Canvas>
...
<Canvas>
  <Story of={FlexItemStories.FlexItemWrapper} meta={FlexItemStories} />
</Canvas>
...
<Canvas>
  <Story of={FlexLayoutStories.WithSeparators} />
</Canvas>
...
<Canvas>
  <Story of={FlexLayoutStories.UsingResponsiveProps} />
</Canvas>
