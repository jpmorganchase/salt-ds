...
You can use the `theme` prop to change the default theme (set to `salt-theme`) by passing a theme name. For more details on Theme please go to <a href="?path=/story/documentation-styles-and-theming-introduction--page">Styles and Theming</a>
