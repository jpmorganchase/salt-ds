...
import * as GridLayoutStories from "./grid-layout.stories";
...
<Canvas>
  <Story of={GridLayoutStories.Default} />
</Canvas>
...
<Canvas>
  <Story of={GridLayoutStories.ResponsiveViewWithCustomBreakpoints} />
</Canvas>
...
<Canvas>
  <Story of={GridLayoutStories.Footer} />
</Canvas>
...
<Canvas>
  <Story of={GridLayoutStories.Composite} />
</Canvas>
