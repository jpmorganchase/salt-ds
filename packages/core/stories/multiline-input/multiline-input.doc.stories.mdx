...
- If the user goes over the character count limit, display an error state.
- Change the styling of the character count text to primary color `--salt-text-primary-foreground` and strong font weight `--salt-text-fontWeight-strong`.
