...
Use a controlled Multiline Input to enforce a character count on the user input. Add the character count as a Label component to present the remaining characters out of the given limit with the encouraged Salt styling.
