...
<Meta
  title="Documentation/Layout/GridLayout"
...
<Canvas>
  <Story id="layout-gridlayout--default-grid-layout" />
</Canvas>
...
You want your layout to flow in a single dimension. In this case we recommend you having a look at [Stack layout](?path=/docs/documentation-layout-stacklayout--page), [Flow layout](?path=/docs/documentation-layout-flowlayout--page) or [Flex layout](?path=/docs/documentation-layout-flexlayout--page).
...
<Canvas>
  <Story id="layout-gridlayout--grid-layout-responsive-view-with-custom-breakpoints" />
</Canvas>
...
<Canvas>
  <Story id="layout-gridlayout--grid-layout-footer" />
</Canvas>
...
<Canvas>
  <Story id="layout-gridlayout--grid-layout-composite" />
</Canvas>
...
- [Border layout](?path=/docs/documentation-layout-borderlayout--page)
