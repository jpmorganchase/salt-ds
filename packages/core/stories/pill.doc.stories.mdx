...
import { Pill, SelectablePill } from "@jpmorganchase/uitk-core";
...
- **Tag content**  
   Use a Pill to organize content that may be mapped to more than one category. It
...
- **Allow multi-selection**  
   When screen space is limited, a Pill can provide a compact way of enabling multi-selection
...
When used in a group, Selectable Pills can enable multi-selection. Their
