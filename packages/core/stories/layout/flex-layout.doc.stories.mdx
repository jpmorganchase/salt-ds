...
For layouts where you need to control the two dimensions, see [Grid layout](?path=/docs/layout-docs-lab-gridlayout--page).
...
If you want your layout to have a constant direction, we recommend you having a look at [Stack layout](?path=/docs/layout-docs-lab-stacklayout--page) or [Flow layout](?path=/docs/layout-docs-lab-flowlayout--page)
