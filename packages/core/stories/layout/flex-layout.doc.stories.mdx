...
<Meta title="Documentation/Core/Layout/FlexLayout" component={FlexLayout} />
...
<Canvas>
  <Story id="layout-core-flexlayout-flexitem--flex-item-wrapper" />
</Canvas>
...
<Canvas>
  <Story id="layout-core-flexlayout--toolkit-flex-layout-responsive" />
</Canvas>
...
<Canvas>
  <Story id="layout-core-flexlayout--flex-layout-simple-usage" />
</Canvas>
