...
import * as BorderItemStories from "./border-item.stories";

<Meta of={BorderLayoutStories} />
...
<Canvas>
  <Story of={BorderLayoutStories.AllPanels} />
</Canvas>
...
<Canvas>
  <Story of={BorderItemStories.BorderItemWrapper} meta={BorderItemStories} />
</Canvas>
...
<Canvas>
  <Story of={BorderLayoutStories.FixedPanels} />
</Canvas>
