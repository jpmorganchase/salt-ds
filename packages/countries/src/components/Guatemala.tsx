...
export type GuatemalaProps = CountrySymbolProps;

export const Guatemala = forwardRef<SVGSVGElement, GuatemalaProps>(
  function Guatemala(props: GuatemalaProps, ref) {
    return (
      <CountrySymbol
