...
export type CaymanIslandsTheProps = CountrySymbolProps;

const CaymanIslandsThe = forwardRef<SVGSVGElement, CaymanIslandsTheProps>(
  function CaymanIslandsThe(props: CaymanIslandsTheProps, ref) {
    return (
      <CountrySymbol
        data-testid="CaymanIslandsThe"
...
export default CaymanIslandsThe;
