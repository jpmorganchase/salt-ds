...
export type GibraltarProps = CountrySymbolProps;

export const Gibraltar = forwardRef<SVGSVGElement, GibraltarProps>(
  function Gibraltar(props: GibraltarProps, ref) {
    return (
      <CountrySymbol
