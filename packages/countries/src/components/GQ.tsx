  ...
  return (
    ...
    >
      ...
      <g mask={`url(#${uid}-GQ-a)`}>
        ...
        <path fill="#0091DA" d="M7.778 10 0 0v20l7.778-10Z" />
        <path
          fill="#C1C3C3"
          d="M10 6.944h5.556v2.009a4.42 4.42 0 0 1-2.778 4.103A4.419 4.419 0 0 1 10 8.953V6.944Z"
        />
        <path fill="#936846" d="M12.222 10h1.111v1.667h-1.111z" />
        <path
          fill="#009B77"
          d="M13.889 8.889a1.111 1.111 0 1 0-2.222 0 .556.556 0 0 0 0 1.111h2.222a.556.556 0 0 0 0-1.111Z"
        />
      </g>
    </CountrySymbol>
  );
