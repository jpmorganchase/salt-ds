...
export type AustraliaProps = CountrySymbolProps;

export const Australia = forwardRef<SVGSVGElement, AustraliaProps>(
  function Australia(props: AustraliaProps, ref) {
    return (
      <CountrySymbol
        data-testid="Australia"
