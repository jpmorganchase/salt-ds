...
export type SvalbardAndJanMayenProps = CountrySymbolProps;

const SvalbardAndJanMayen = forwardRef<SVGSVGElement, SvalbardAndJanMayenProps>(
  function SvalbardAndJanMayen(props: SvalbardAndJanMayenProps, ref) {
    return (
      <CountrySymbol
        data-testid="SvalbardAndJanMayen"
