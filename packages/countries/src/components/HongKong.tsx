...
export type HongKongProps = CountrySymbolProps;

const HongKong = forwardRef<SVGSVGElement, HongKongProps>(function HongKong(
  props: HongKongProps,
  ref
) {
  return (
    <CountrySymbol
      data-testid="HongKong"
      aria-label="Hong Kong"
      viewBox="0 0 72 72"
      ref={ref}
      {...props}
    >
      <mask id="HK__a" x="0" y="0" maskUnits="userSpaceOnUse" mask-type="alpha">
        <circle
          cx="36"
          cy="36"
          r="36"
