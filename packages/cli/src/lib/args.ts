...
const ROOT_HELP = [
  ...
  "  salt-ds create <query> [--json] [--json-file <path>] [--output <path>] [--registry-dir <path>] [--include-starter-code] [--type <auto|component|pattern|composition|foundation|token>] [--package <name>] [--status <stable|beta|lab|deprecated>] [--resolved-entity <name>] [--starter-only] [--full]",
...
const COMMAND_HELP: Record<string, string[]> = {
  create: [
    ...
    "",
    "Usage:",
    "  salt-ds create <query> [--json] [--full] [--include-starter-code] [--resolved-entity <name>] [--registry-dir <path>]",
    "",
    "Purpose:",
    ...
    '  salt-ds create "profile page with tabs and avatar" --resolved-entity Avatar --json',
