...
const ROOT_HELP = [
  ...
  "  salt-ds review [target ...] [--url <url>] [--create-report <path>] [--migration-report <path>] [--report <path>] [--validate <report.json>] [--resume <report.json>] [--json] [--json-file <path>] [--output <path>] [--registry-dir <path>] [--timeout <ms>] [--mode <auto|browser|fetched-html>] [--output-dir <path>] [--no-screenshot] [--full] [--hook]",
...
const COMMAND_HELP: Record<string, string[]> = {
  ...
  review: [
    ...
    "",
    "Usage:",
    "  salt-ds review [target ...] [--url <url>] [--create-report <path>] [--migration-report <path>] [--report <path>] [--validate <report.json>] [--resume <report.json>] [--json] [--full] [--hook]",
    "",
    "Purpose:",
