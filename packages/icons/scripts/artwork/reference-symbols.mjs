...
// Close on the smooth left flank rather than at the pointed tip: coordinate
// rounding during export must not add a third segment at the bottom join.
// Both surfaces retain the complete stroked perimeter and its softened interior.
const heart =
  "M2.5 8.3C2.5 5.65 4.6 3.45 7.25 3.45C9.25 3.45 10.65 4.75 12 7C13.35 4.75 14.75 3.45 16.75 3.45C19.4 3.45 21.5 5.65 21.5 8.3C21.5 13.5 15.2 18.4 12 20.55C8.8 18.4 2.5 13.5 2.5 8.3Z";
const heartOutline = SF(heart, { radius: 1.15 });
...
const referenceSymbols = {
  ...
  like: [heartOutline, F(heart) + heartOutline],
  currency: [
