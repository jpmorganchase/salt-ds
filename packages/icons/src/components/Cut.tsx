...
export const CutIcon = forwardRef<SVGSVGElement, CutIconProps>(function CutIcon(
  ...
  return (
    ...
    >
      <>
        <path d="m1.967 0 3.726 4.769-1.115 1.428a294.918 294.918 0 0 1-2.567-3.338C1.414 2.039.928.811 1.967-.001z" />
        <path d="M8.349 11.049a1.584 1.584 0 1 0 .677-2.013L7.454 7.023l-.477.614-.641.825 2.013 2.587zm2.275-.65a.823.823 0 1 1-1.645.035.823.823 0 0 1 1.645-.035z" />
