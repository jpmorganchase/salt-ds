  ...
  return (
    ...
    >
      <g strokeWidth="var(--icon-strokeWidth, 1)">
        ...
        <path
          fillRule="evenodd"
          d="M4.494 5.361v.543H.834v-.498l2.758-3.988H.878V.872h3.505v.483L1.618 5.361Z"
        />
        <path
          fill="none"
          stroke="var(--saltIcon-color, var(--icon-color, currentColor))"
        ...
        <path
          fillRule="evenodd"
          d="m4.193 14.808-.48-1.317H1.607l-.477 1.317H.45l1.918-5.033h.584l1.925 5.033Zm-.678-1.863-.853-2.347-.854 2.347Z"
        />
        <path
          fill="none"
          stroke="var(--saltIcon-color, var(--icon-color, currentColor))"
