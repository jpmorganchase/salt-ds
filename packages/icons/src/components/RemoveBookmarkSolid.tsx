...
export type RemoveBookmarkSolidIconProps = IconProps;

export const RemoveBookmarkSolidIcon = forwardRef<
  SVGSVGElement,
  RemoveBookmarkSolidIconProps
>(function RemoveBookmarkSolidIcon(props: RemoveBookmarkSolidIconProps, ref) {
  return (
    <Icon
      data-testid="RemoveBookmarkSolidIcon"
      aria-label="remove bookmark solid"
      viewBox="0 0 16 16"
      ref={ref}
      {...props}
    >
      <g strokeWidth="var(--icon-strokeWidth, 1)">
        <path
          fillRule="evenodd"
          d="M3.923 1h8.154v13.25L8 11.192 3.923 14.25ZM5.5 6h5v1.5h-5Z"
        />
        <path
          fill="none"
