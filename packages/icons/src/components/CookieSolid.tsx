...
export const CookieSolidIcon = createIcon(
  <svg viewBox="0 0 12 12" fill="none" data-testid="CookieSolidIcon">
    <path
      clip-rule="evenodd"
    ...
    />
    <path d="M9 1.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Zm2 2a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Zm1-3a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z" />
  </svg>,
  "CookieSolid",
  "CookieSolid"
);
