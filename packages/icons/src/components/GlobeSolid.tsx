...
export const GlobeSolidIcon = forwardRef<SVGSVGElement, GlobeSolidIconProps>(
  function GlobeSolidIcon(props: GlobeSolidIconProps, ref) {
    return (
      ...
      >
        <>
          <path d="M6.041 10.802C6.826 9.881 7.368 8.941 7.677 8H4.356c.325.942.883 1.882 1.686 2.802z" />
          <path d="M7.919 7a5.904 5.904 0 0 0-.031-2H4.095a5.94 5.94 0 0 0 .001 2h3.822z" />
          <path d="M7.614 4c-.329-.911-.876-1.819-1.655-2.709C5.197 2.181 4.666 3.09 4.352 4h3.262z" />
