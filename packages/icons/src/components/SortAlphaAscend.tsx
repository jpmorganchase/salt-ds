  ...
  return (
    ...
    >
      <>
        ...
        />
        <path d="M4.092 11.997H.5v-.564l2.543-3.736H.579V7h3.445v.56L1.48 11.3h2.611v.697Z" />
        <path d="M9 1v8.105l1.6-1.597.708.706-2.8 2.795L5.7 8.206l.708-.706L8 9.089V1h1Z" />
      </>
    </Icon>
  );
});
