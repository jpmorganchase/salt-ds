...
>(function AnnouncementIcon(props: AnnouncementIconProps, ref) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M9.576 9.228 4.878 8.55l.143 1.53a1.25 1.25 0 0 1-.92 1.326l-.061.015a1.25 1.25 0 0 1-1.553-.98l-.338-1.83-.79.103-.435.056L0 5.32l.403-.168 2.284-.951 3.981-3.134L7.265.6l2.311 8.628Zm-6.433-.744.328 1.777a.25.25 0 0 0 .31.196l.06-.016a.251.251 0 0 0 .185-.266L3.87 8.521a.148.148 0 0 0-.086-.12l-.641.083Zm.368-3.658.702 2.62 4.005.576L6.69 2.324 3.51 4.826ZM1.192 5.909l.472 1.76 1.52-.198-.577-2.152-1.415.59Z"
        clipRule="evenodd"
      />
