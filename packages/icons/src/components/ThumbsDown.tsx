    ...
    return (
      ...
      >
        <>
          ...
          <path d="m7 8.764 1-2V1H2.618L1 4.236V6.5a.5.5 0 0 0 .5.5H6v3.5a.5.5 0 0 0 .5.5H7V8.764zM8 12H6.5A1.5 1.5 0 0 1 5 10.5V8H1.5A1.5 1.5 0 0 1 0 6.5V4l2-4h7v7L8 9v3z" />
        </>
      </Icon>
    );
  }
