...
- 0f92b84: Added bold and subtle ghost container border color tokens. Updated the default ghost container border color to use the medium-low contrast palette color.
