...
4. Append the attribute, e.g. `--uitk-actionable-cta-background`, `--uitk-text-h2-font-size`, `--uitk-focused-color`
5. Append the state if applicable, e.g. `--uitk-actionable-cta-background-hover`, `--uitk-focused-color-warning`
...
theme, --uitk-actionable-primary-background resolves to `var(--uitk-color-grey-60)`, and in dark theme resolves to `var(--uitk-color-grey-300)`, of which foundation tokens then in turn resolve to their respective RGBA values.
