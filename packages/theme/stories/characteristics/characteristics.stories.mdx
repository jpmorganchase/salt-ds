...
4. Append the attribute, e.g. `--uitk-actionable-cta-background`, `--uitk-text-h2-font-size`, `--uitk-focused-outline-color`
5. Append the state if applicable, e.g. `--uitk-actionable-cta-background-hover`, `--uitk-focused-outline-color-warning`
