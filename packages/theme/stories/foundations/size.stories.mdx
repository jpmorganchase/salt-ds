...
<DocGrid>
  <SpacingBlock spacingVar="--salt-size-brandBar" /> **deprecated**: use
  --salt-size-accent instead
  <SpacingBlock spacingVar="--salt-size-detail" /> **deprecated**: use --salt-size-compact
  instead
  <SpacingBlock spacingVar="--salt-size-selection" /> **deprecated**: use
  --salt-size-selectable instead
</DocGrid>
