...
<DocGrid>
  ...
  <SpacingBlock spacingVar="--salt-size-brandBar" /> **deprecated**
  ...
  <SpacingBlock spacingVar="--salt-size-detail" /> **deprecated**
  ...
  <SpacingBlock spacingVar="--salt-size-selection" /> **deprecated**
