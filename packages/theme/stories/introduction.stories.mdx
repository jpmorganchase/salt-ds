...
| Editable            | components that have mutable input                                                | `--uitk-editable-border-style: solid;`                                                                |
| Focused             | components that have a focused state                                              | ` --uitk-focused-outline-style: dotted;`                                                              |
| Measured            | components which have some form of scale or progress                              | `--uitk-measured-border-color: var(--uitk-palette-measure-border);`                                   |
...
| Separable           | components containing elements which should be separated into different divisions | `--uitk-separable-primary-border-color: var(--uitk-palette-neutral-border-low);`                      |
