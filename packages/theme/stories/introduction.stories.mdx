...
| --------------- | ------------------------------------------------------ | --------------------------------------------------------- |
| Color           | The core set of colors available                       | `--uitk-color-gray-800: rgb(36, 37, 38);`                 |
...
| Info              | Characteristics symbolising an info state                       | `--uitk-palette-info-foreground`                          |
| Success           | Characteristics symbolising a success state                     | `--uitk-palette-success-border`                           |
| Warning           | Characteristics symbolising a warning state                     | `--uitk-palette-warning-foreground`                       |
...
```html
<uitk-theme class="uitk-theme uitk-density-high" data-mode="light">
  <rest-of-my-application />
</uitk-theme>
```
...
```css
.uitk-theme[data-mode="light"] {
  --uitk-palette-interact-primary-foreground: var(--uitk-gray-900);
}
