...
| Separable           | components containing elements which should be separated into different divisions | `--uitk-separable-border-color-1: var(--uitk-palette-neutral-border-low);`                            |
