...
| Actionable          | components on which the user can perform an action                              | `--uitk-actionable-foreground-primary: var(--uitk-color-grey-900);`        |
| Container           | components that may encapsulate others                                          | `--uitk-container-border-width: 1px;`                                      |
| Delay               | components which have a delay before some form of transition                    | `--uitk-delay-duration-instant: 100;`                                      |
...
```css
.uitk-light {
  --uitk-actionable-foreground-primary: var(--uitk-grey-900);
}
.uitk-dark {
  --uitk-actionable-foreground-primary: var(--uitk-white);
}
```
