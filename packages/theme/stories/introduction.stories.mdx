...
| **Deprecated:** Icon  | Core set of icons available within the Salt theme                   | Replaced with size                     | Replaced with size                |
...
| Foreground                   | INSERT_DESCRIPTION_HERE                                                              | `--salt-foreground-primary`                  | `--salt-palette-neutral-primary-foreground`        |
