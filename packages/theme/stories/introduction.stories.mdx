...
| **Deprecated:** Icon  | Replaced with size                                                  | Replaced with size                     | Replaced with size                |
...
| Foreground                   | Provides default values for text and icon display                                    | `--salt-foreground-primary`                  | `--salt-palette-neutral-primary-foreground`        |
