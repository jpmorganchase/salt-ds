...
| Delay      | Durations between a user action and system feedback      | `--salt-delay-cutoff`                  | `10000`                           |
...
| Size       | Sizes in px used for padding, height, border width, etc. | `--salt-size-basis-unit`               | `4px`                             |
...
| Measure          | Colors used to represent a measurement, value, or progression                | `--salt-palette-measured-fill`              | `--salt-color-blue-500`   |
...
| Differential **deprecated** | Components indicating a positive or negative change                                  | `--salt-differential-positive-foreground`    | `--salt-palette-positive-foreground`               |
...
| Measured                    | Components that indicate a changeable value or progression                           | `--salt-measured-borderColor`                | `--salt-palette-measured-border`                   |
