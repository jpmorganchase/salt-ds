...
| Error             | characteristics symbolizing an error state                      | `--uitk-palette-error-border`                            |
| Info              | characteristics symbolizing an info state                       | `--uitk-palette-info-icon`                               |
| Success           | characteristics symbolizing a success state                     | `--uitk-palette-success-border`                          |
| Warning           | characteristics symbolizing a warning state                     | `--uitk-palette-warning-icon`                            |
...
| Neutral           | characteristics with no specialized semantic meaning            | `--uitk-palette-neutral-primary-foreground`              |
