...
| Actionable          | components on which the user can perform an action                              | ` --uitk-actionable-primary-background-hover: var(--uitk-palette-action-primary-background-hover);` |
| Container           | components that may encapsulate others                                          | `--uitk-container-border-width: 1px;`                                                               |
| Differential        | components indicating a positive or negative change                             | `--uitk-differential-foreground-positive: var(--uitk-palette-positive-foreground);`                 |     |
...
| Editable            | components that have mutable input                                              | `--uitk-editable-foreground: var(--uitk-palette-action-foreground);;`                               |
| Focused             | components that have a focused state                                            | ` --uitk-focused-outline-style: dotted;`                                                            |
| Measured            | components which have some form of scale or progress                            | `--uitk-measured-border-color: var(--uitk-palette-neutral-endpoint);`                               |
...
| Separable           | components containing elements which should be separated into different divions | `--uitk-separable-border-color-1: var(--uitk-palette-neutral-border-low);`                          |
| Status              | components indicating an informational, warning, error or success state         | `--uitk-status-info-border-color: var(--uitk-palette-info-border);`                                 |
| Taggable            | components which allow data to be organized                                     | `--uitk-taggable-background: var(--uitk-palette-action-primary-background);`                        |
| Text                | all text components or HTML elements                                            | `--uitk-text-primary-color: var(--uitk-palette-neutral-primary-foreground);`                        |
...
.uitk-dark {
  --uitk-actionable-primary-foreground: var(
    --uitk-palette-action-primary-foreground
  );
}
```
...
```css
.uitk-light {
  --uitk-palette-action-primary-foreground: var(--uitk-grey-900);
}
.uitk-dark {
  --uitk-palette-action-primary-foreground: var(--uitk-white);
}
```
