...
<Canvas>
  <DocGrid withNotes>
    <ColorBlock colorVar="--salt-palette-warning-background-emphasize" replacementToken="--salt-palette-warning-background" />

    <ColorBlock colorVar="--salt-palette-warning-border-disabled" replacementToken="#EA731966" />
