...
- Note whether local wrappers, patterns, or repo conventions were checked through separate project conventions or explicit repo guidance when they could change the review outcome.
