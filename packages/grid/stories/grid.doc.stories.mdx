...
To import the grid into your application, run the following call:

```
import { Grid } from "@salt-ds/data-grid";
```

Note: ensure the CSS `height` property for `.saltGrid` has been set appropriately to see grid on screen.
...
<Canvas>
  <Story id="data-grid-data-grid--grid-variants" decorators={[withFlexGap]} />
</Canvas>
...
<Canvas>
  <Story id="data-grid-data-grid--column-groups" decorators={[withFlexGap]} />
</Canvas>
...
<Canvas>
  <Story id="data-grid-data-grid--server-side-data" />
</Canvas>
...
<Canvas>
  <Story
    id="data-grid-data-grid--row-selection-modes"
...
<Canvas>
  <Story
    id="data-grid-data-grid--row-selection-controlled"
    decorators={[withFlexGap]}
  />
</Canvas>
...
<Canvas>
  <Story
    id="data-grid-data-grid--cell-customization"
    decorators={[withFlexGap]}
  />
</Canvas>

The second way to customize cell appearance is the `cellComponent` property.
...
<Canvas>
  <Story
    id="data-grid-data-grid--header-customization"
    decorators={[withFlexGap]}
  />
</Canvas>
...
<Canvas>
  <Story id="data-grid-data-grid--editable-cells" decorators={[withFlexGap]} />
</Canvas>
...
The grid columns have two types of built-in validation, "light" and "strong". The default style is "light". They both only apply the visual styling. You will need to provide the validation logic yourself.
If you are validating editable cells, we recommend you use a 3rd party library like [yup](https://www.npmjs.com/package/yup) or [zod]https://www.npmjs.com/package/zod). The first validation type "light", applies a status color to the background and border,
while the second type "strong" also displays a status icon. Light validation is supposed to be used with non-editable cells, and strong with editable cells.

<Canvas>
  <Story id="data-grid-data-grid--cell-validation" decorators={[withFlexGap]} />
</Canvas>

<Canvas>
  <Story id="data-grid-data-grid--row-validation" decorators={[withFlexGap]} />
</Canvas>
...
<Canvas>
  <Story id="data-grid-data-grid--grid-pagination" decorators={[withFlexGap]} />
</Canvas>
