...
If you add an interactive element with complex keyboard functionality, you will have to prevent the keyboard events from bubbling up otherwise the grid keyboard event listeners will clash with the child element and potentially break keyboard interactions.
