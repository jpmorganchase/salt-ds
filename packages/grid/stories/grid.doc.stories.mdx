...
<LazyStoryCanvas>
  <Canvas>
    <Story id="data-grid-data-grid--simple-grid" decorators={[withFlexGap]} />
  </Canvas>
</LazyStoryCanvas>
...
<LazyStoryCanvas>
  <Canvas>
    <Story
      id="data-grid-data-grid--editable-cells"
      decorators={[withFlexGap]}
    />
  </Canvas>
</LazyStoryCanvas>
...
To display a cell in one of expected validation states, use the `getValidationState` prop on the `GridColumn` component. This prop is a function that provides row and column data, and expects as return value one of known validation states, "error", "warning", and "success".
...
Another optional prop to customize the validation is `validationType`. This can be either "strong", or "light". The default value is "light". Both options only apply the visual styling. You will need to provide the validation logic yourself.
...
<Canvas>
  <Story
    id="data-grid-data-grid--cell-and-row-validation"
    decorators={[withFlexGap]}
  />
</Canvas>
...
<LazyStoryCanvas>
  <Canvas>
    <Story
      id="data-grid-data-grid--grid-pagination"
      decorators={[withFlexGap]}
    />
  </Canvas>
</LazyStoryCanvas>
