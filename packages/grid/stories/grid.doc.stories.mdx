...
Below is an example of two grids with synchronised selections.
...
<Canvas>
  <Story name="Cell value customization" decorators={[withFlexGap]}>
    <CellCustomizationExample />
  </Story>
</Canvas>
...
The grid below is editable. Change the values of CSS variables to see the effect of applying them to the grid.
