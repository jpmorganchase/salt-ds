...
Use the following call to import the grid.
...
The grid allows the use of any renderable react components for cell customization. There is two ways to customize cell appearance:
