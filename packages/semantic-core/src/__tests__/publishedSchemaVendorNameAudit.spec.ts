...
//
// Published schemas describe what data *means*, never how a particular CI
...
//
// Audited surface: every `*.schema.json` under `packages/semantic-core/schemas/`.
...
describe("published JSON schemas — vendor-name regression test (PR 20 / task 0.12)", () => {
