...
// Type-only workflow-contract surface: extracted into a sibling module so the
// workflowContracts barrel stays under the §1.1 600-line cap. Re-export keeps
// every existing `from "./workflowContracts.js"` import path working.
export type {
  CreateSaltUiWorkflowContract,
  FollowThroughItem,
  MigrateToSaltWorkflowContract,
  RepoAwareReviewMigrationVerification,
  RepoAwareReviewWorkflowInput,
  RepoAwareReviewWorkflowMetadata,
  ReviewSaltUiWorkflowContract,
  UpgradeSaltUiWorkflowContract,
  WorkflowConfidence,
  WorkflowContextRequirement,
  WorkflowContextResolutionStatus,
  WorkflowCreateIdeSummary,
  WorkflowCreateImplementationGate,
  WorkflowCreateImplementationGateRuleId,
...
// Local type aliases so internal references stay unqualified.
import type {
  CreateSaltUiWorkflowContract,
  FollowThroughItem,
  MigrateToSaltWorkflowContract,
