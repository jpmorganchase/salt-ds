...
// Type-only public contract surface: extracted into a sibling module so the
// publicContract barrel stays under the §1.1 600-line cap. Re-export keeps the
// existing `from "./publicContract.js"` import paths working.
export type {
  PublicWorkflowId,
  PublicTransportUsed,
  ...
  PublicContractSafety,
  PublicPostAction,
  PublicAction,
  PublicContract,
  PublicWorkflowDetailsEnvelope,
  PublicContractExactRequest,
  PublicContractState,
  PublicContractInput,
  PublicContractBuildOptions,
} from "./publicContract/types.js";
export {
...
// Local aliases so internal usage below stays unchanged.
import type {
  PublicAction,
  PublicActionHints,
  PublicActionKind,
