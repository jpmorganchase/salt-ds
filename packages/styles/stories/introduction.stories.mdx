...
Style injection is the act of adding CSS styles dynamically to a document rather than statically linking them. Typically, CSS-in-JS libraries do this but there are standalone libraries that do this are:
...
and overriding an application's styles.
