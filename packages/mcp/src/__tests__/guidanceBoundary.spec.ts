...
} from "../core/tools/guidanceBoundary.js";
...
describe("guidanceBoundary", () => {
  ...
  it("derives project convention guidance for exact Salt references", () => {
    const entityBoundary = buildGuidanceBoundary({
      workflow: "get_salt_reference",
      entity_type: "component",
    });

    expect(entityBoundary.project_conventions).toMatchObject({
      check_recommended: true,
      topics: ["wrappers"],
    });
  });
