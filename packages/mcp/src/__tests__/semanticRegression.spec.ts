...
import { detectFromOutline } from "../core/tools/translation/sourceUiDetection.js";
import { buildTranslationRecords } from "../core/tools/translation/sourceUiMapping.js";
import { buildSourceUiModel } from "../core/tools/translation/sourceUiModel.js";
import type {
  ComponentRecord,
  PatternRecord,
  SaltRegistry,
...
describe("semantic regression guards", () => {
  ...
  it("keeps grouped app-shell translation on the vertical navigation family", () => {
