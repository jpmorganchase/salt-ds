...
export type { StarterCodeSnippet };
...
export type MigrationDeltaCategory =
  | "direct-swap"
  | "salt-recomposition"
...
export type SourceUiStateKind = "loading" | "empty" | "error" | "validation";
...
export interface SourceIntentProfile {
  query: string;
...
export type VisualEvidenceInputType =
  | "structured-outline"
  | "current-ui-capture"
  | "mockup-image"
  | "screenshot-file"
...
export type VisualEvidenceKind = "mockup" | "screenshot";
export type VisualEvidenceSourceType = "file" | "url";
export type VisualEvidenceConfidence = "low" | "medium" | "high";

export interface NormalizedVisualEvidenceInput {
  kind: VisualEvidenceKind;
  source_type: VisualEvidenceSourceType;
  source: string;
  label?: string;
  derived_outline: SourceUiOutlineInput;
...
export interface TranslationRecord {
  ...
  migration_kind: TranslationMigrationKind;
  delta_category: MigrationDeltaCategory;
...
export interface MigrationFamiliarityContract {
  preserve: string[];
  allow_salt_changes: string[];
...
export interface MigrateToSaltInput {
  code?: string;
  query?: string;
...
export interface MigrateToSaltResult {
  ...
  familiarity_contract: MigrationFamiliarityContract;
  migration_checkpoints: MigrationCheckpoint[];
  assumptions?: string[];
  ...
  decision_gates?: Array<{
    ...
    question: string;
    reason: string;
    suggested_workflow: "create_salt_ui" | "get_salt_reference";
  }>;
