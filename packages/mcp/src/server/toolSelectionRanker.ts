 ...
 *     tools.
 *
 * Internal-only. Not exported from `packages/mcp/src/index.ts`. Used by
 * `agenticEvals.spec.ts` to assert the right Salt tool ranks #1 for a
 * representative 20-prompt corpus.
 */
