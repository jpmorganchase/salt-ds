...
- `packages/mcp/docs/consumer/consuming-project-conventions.md`
- `packages/skills/references/project-conventions.md`
...
- `packages/skills/skills/salt-project-conventions`
...
- `packages/semantic-core/src/tools`
- `packages/cli/src/commands/workflow.ts`
- `packages/skills/skills/salt-ds/SKILL.md`
