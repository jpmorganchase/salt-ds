...
const sourceSchemaDir = path.resolve(
  packageRoot,
  "..",
  "semantic-core",
  "schemas",
...
const distSchemaDir = path.resolve(
  packageRoot,
  "..",
  "..",
  "dist",
...
await fs.rm(distSchemaDir, { recursive: true, force: true });
await fs.cp(sourceSchemaDir, distSchemaDir, { recursive: true });
